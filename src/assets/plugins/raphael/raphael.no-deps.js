...
;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Raphael'] = factory(require('eve'))
  ...
  \*****************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__
          !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ 'eve')]),
    ...
    \*/
            function R(first) {
              if (R.is(first, 'function')) {
                ...
                return R._engine.create[apply](R, first.splice(0, 3 + R.is(first[0], nu))).add(
                  first
                )
              } else {
              ...
              a2c = function (
                ...
                if (!recursive) {
                  ...
                  var rx2 = rx * rx,
                    ...
                    k =
                      ...
                      math.sqrt(
                        abs((rx2 * ry2 - rx2 * y * y - ry2 * x * x) / (rx2 * y * y + ry2 * x * x))
                      ),
                ...
                if (recursive) {
                  ...
                  for (var i = 0, ii = res.length; i < ii; i++) {
                    newres[i] =
                      i % 2 ? rotate(res[i - 1], res[i], rad).y : rotate(res[i], res[i + 1], rad).x
                  }
                  return newres
                }
              },
    ...
    \*/
            ...
            var getOffset = function (elem) {
              var box = elem.getBoundingClientRect(),
                ...
                top =
                  box.top + (g.win.pageYOffset || docElem.scrollTop || body.scrollTop) - clientTop,
                left =
                  box.left +
    ...
    \*/
            elproto.animateWith = function (el, anim, params, ms, easing, callback) {
              ...
              var a =
                  params instanceof Animation ? params : R.animation(params, ms, easing, callback),
                x,
                y
            ...
            elproto.pause = function (anim) {
              for (var i = 0; i < animationElements.length; i++)
                if (
                  ...
                  if (
                    eve('raphael.anim.pause.' + this.id, this, animationElements[i].anim) !== false
                  ) {
            ...
            elproto.stop = function (anim) {
              for (var i = 0; i < animationElements.length; i++)
                if (
                  ...
                  if (
                    eve('raphael.anim.stop.' + this.id, this, animationElements[i].anim) !== false
                  ) {
                    animationElements.splice(i--, 1)
                  }
                }
    ...
    \*/
            paperproto.getFont = function (family, weight, style, stretch) {
              ...
              style = style || 'normal'
              weight =
                +weight || { normal: 400, bold: 700, lighter: 300, bolder: 800 }[weight] || 400
              if (!R.fonts) {
                return
              }
            ...
            var addArrow = function (o, value, isEnd) {
              ...
              setFillAndStroke = function (o, params) {
                ...
                if (
                  ...
                  var stroke =
                      node.getElementsByTagName('stroke') && node.getElementsByTagName('stroke')[0],
                    newstroke = false
