!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module
    ? (module.exports = e(require('eve')))
    : 'function' == typeof define && define.amd
    ? define(['eve'], e)
    : 'object' == typeof exports
    ? (exports.Raphael = e(require('eve')))
    : (t.Raphael = e(t.eve))
})(window, function (t) {
  return (function (t) {
    var e = {}
        ...
        void 0 ===
          (n = function (t) {
            ...
            ;(e.getRGB = ht(function (t) {
              ...
              !D[o](t.toLowerCase().substring(0, 2)) && '#' != t.charAt() && (t = it(t))
              var r,
                i,
                n,
                a,
              ...
              return h
                ? (h[2] &&
                    ((n = z(h[2].substring(5), 16)),
                    (i = z(h[2].substring(3, 5), 16)),
                    (r = z(h[2].substring(1, 3), 16))),
                  h[3] &&
                    ((n = z((s = h[3].charAt(3)) + s, 16)),
                    (i = z((s = h[3].charAt(2)) + s, 16)),
                    (r = z((s = h[3].charAt(1)) + s, 16))),
                  h[4] &&
                    ((l = h[4][v](I)),
                    (r = F(l[0])),
                    '%' == l[0].slice(-1) && (r *= 2.55),
                    ...
                    (n = F(l[2])),
                    '%' == l[2].slice(-1) && (n *= 2.55),
                    'rgba' == h[1].toLowerCase().slice(0, 4) && (a = F(l[3])),
                  ...
                  h[5]
                    ? ((l = h[5][v](I)),
                      ...
                      'hsba' == h[1].toLowerCase().slice(0, 4) && (a = F(l[3])),
                      l[3] && '%' == l[3].slice(-1) && (a /= 100),
                      e.hsb2rgb(r, i, n, a))
                    : h[6]
                    ? ((l = h[6][v](I)),
                      ...
                      '%' == l[2].slice(-1) && (n *= 2.55),
                      ('deg' == l[0].slice(-3) || '°' == l[0].slice(-1)) && (r /= 360),
                      'hsla' == h[1].toLowerCase().slice(0, 4) && (a = F(l[3])),
                      l[3] && '%' == l[3].slice(-1) && (a /= 100),
                      e.hsl2rgb(r, i, n, a))
                  ...
                  ? function (t, e, r, i) {
                      var n = function (t) {
                        ...
                        var e = l.doc.documentElement.scrollTop || l.doc.body.scrollTop,
                          ...
                          s = t.clientY + e
                        return (
                          (t.preventDefault = t.preventDefault || Ft),
            ...
            ;(Wt.drag = function (r, i, n, a, s, o) {
              function h(h) {
                ...
                ;(this._drag.x = u + d),
                  (this._drag.y = c + f),
                  !Dt.length && e.mousemove(Ot).mouseup(Vt),
                  Dt.push({ el: this, move_scope: a, start_scope: s, end_scope: o }),
                ...
                if (c) (c.initstatus = s), (c.start = new Date() - c.ms * s)
                  ...
                  for (var S in u)
                    if (u[o](S) && (q[o](S) || i.paper.customAttributes[o](S)))
                      switch (
                        ((b[S] = i.attr(S)), null == b[S] && (b[S] = j[S]), (_[S] = u[S]), q[S])
                      ) {
                        case T:
                          w[S] = (_[S] - b[S]) / m
                          break
                        ...
                        case 'transform':
                          ...
                          if (R)
                            ...
                            var I = i.matrix || new Pt(),
                              D = {
                                _: { transform: z.transform },
                                getBBox: function () {
                                  return i.getBBox(1)
                                }
                              }
                            ;(b[S] = [I.a, I.b, I.c, I.d, I.e, I.f]),
                              Et(D, _[S]),
                              (_[S] = D._.transform),
                              (w[S] = [
                                (D.matrix.a - I.a) / m,
            ...
            return (
              ...
              (e.registerFont = function (t) {
                ...
                if ((this.fonts[r] ? this.fonts[r].push(e) : (this.fonts[r] = [e]), !t.svg))
                  for (var n in ((e.face['units-per-em'] = z(t.face['units-per-em'], 10)),
                  t.glyphs))
                    if (t.glyphs[o](n)) {
                      var a = t.glyphs[n]
                      if (
                  ...
                  for (var d in ((l.style.visibility = 'hidden'), a))
                    if (a[e](d)) {
                      ...
                      switch (((u[d] = g), d)) {
                        ...
                        case 'fill-opacity':
                          if (u.gradient) {
                            ;(F = t._g.doc.getElementById(
                              l.getAttribute('fill').replace(/^url\(#|\)$/g, c)
                            )) &&
                              ((z = F.getElementsByTagName('stop')),
              ...
              var k,
                ...
                C = function (n, l) {
                  ...
                  if ('clip-rect' in l) {
                    ...
                    if (4 == P.length) {
                      ...
                      var F = u.clipRect || t._g.doc.createElement('div'),
                        z = F.style
                      ;(z.clip = t.format('rect({1}px {2}px {3}px {0}px)', P)),
                        u.clipRect ||
                          ((z.position = 'absolute'),
                          (z.top = 0),
                          (z.left = 0),
                  ...
                  if (
                    ...
                    if (
                      ((D = o(s(D, 0), 1)),
                      null == l['stroke-width'] && (G = g['stroke-width']),
                      l['stroke-width'] && (O.weight = G),
                      G && G < 1 && (D *= G) && (O.weight = 1),
                      (O.opacity = D),
