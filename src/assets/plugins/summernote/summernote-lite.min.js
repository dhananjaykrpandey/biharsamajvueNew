      ...
      (() => {
        ...
        function ot(t, e) {
          ...
          if (O(t.node) === t.offset) {
            ...
            tt(t.node)
              ...
              : ((o = t.node), (n = e ? O(t.node) : t.offset + 1))
          return { node: o, offset: n }
        }
        function nt(t, e) {
          var o,
          ...
          if (O(t.node) === t.offset) {
            ...
            if (((n = 0), j((o = t.node.childNodes[t.offset]))))
              return j(t.node.nextSibling) ? null : { node: t.node.nextSibling, offset: n }
        ...
        function at(t, e) {
          ...
          return (
            _(a, V(r)),
            o || (U(t.node), U(a)),
            i && (j(t.node) && ct(t.node), j(a)) ? (ct(a), t.node.nextSibling) : a
          )
        }
        function st(t, e, o) {
          ...
          return n.length
            ? 1 === n.length
              ...
              : n.reduce(function (t, n) {
                  return t === e.node && (t = at(e, o)), at({ node: n, offset: t ? J(t) : O(n) }, o)
                })
            : null
        }
        function lt(t) {
        ...
        const ht = {
          ...
          splitPoint: function (t, e) {
            ...
            return (
              s || n !== t.node || (s = t.node.childNodes[t.offset]), { rightNode: s, container: n }
            )
          },
          create: lt,
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  var t = this
                  ;(this.options.id = v.uniqueId(e().now())),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  ;(e.shouldInitialize = e.shouldInitialize || v.ok),
                    e.shouldInitialize() &&
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this.modules[t]
                  e.shouldInitialize() &&
                    (e.events && ht.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
            ...
            (n = [
                ...
                value: function (t) {
                  ...
                  return (
                    t.scrollTop + o < this.sc.offsetTop &&
                      (t.scrollTop += Math.abs(t.scrollTop + o - this.sc.offsetTop)),
                    this
                  )
                }
              },
              {
                ...
                value: function () {
                  var e = function (t, e) {
                      ...
                      return (
                        (e
                          ? ht.nextPointUntil(ht.nextPoint(t), ht.isVisiblePoint)
                          : ht.prevPointUntil(ht.prevPoint(t), ht.isVisiblePoint)) || t
                      )
                    },
                    ...
                    ht.walkPoint(
                      ...
                      function (e) {
                        ...
                        ht.isEditable(e.node) ||
                          (n
                            ? (ht.isLeftEdgePoint(e) && s.push(e.node),
                              ht.isRightEdgePoint(e) && y.contains(s, e.node) && (i = e.node))
                            : (i = o ? ht.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i))
                      },
                      !0
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ht.isText(this.ec) &&
                      !ht.isEdgePoint(this.getEndPoint()) &&
                      this.ec.splitText(this.eo),
                    ht.isText(this.sc) &&
                      !ht.isEdgePoint(this.getStartPoint()) &&
              ...
              },
              {
                ...
                value: function () {
                  if (ht.isBodyContainer(this.sc) && ht.isEmpty(this.sc))
                    return (
                      (this.sc.innerHTML = ht.emptyPara),
                  ...
                  if (ht.isInline(o.sc)) {
                    ...
                    ;(e = y.last(n)),
                      ht.isInline(e) || (e = n[n.length - 2] || o.sc.childNodes[o.so])
                  ...
                  return (
                    o.rightNode
                      ? (o.rightNode.parentNode.insertBefore(t, o.rightNode),
                        ht.isEmpty(o.rightNode) &&
                          ht.isPara(t) &&
                          o.rightNode.parentNode.removeChild(o.rightNode))
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e &&
                      (o = ht.nextPointUntil(o, function (t) {
                        return !ht.isCharPoint(t)
                      })),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e && (o = ht.nextPointUntil(o, n)), new t(i.node, i.offset, o.node, o.offset)
                  )
                }
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  return {
                    s: { path: ht.makeOffsetPath(t, this.sc), offset: this.so },
                    e: { path: ht.makeOffsetPath(t, this.ec), offset: this.eo }
                  }
                }
              },
              {
                ...
                value: function (t) {
                  return {
                    s: { path: y.tail(ht.makeOffsetPath(y.head(t), this.sc)), offset: this.so },
                    e: { path: y.tail(ht.makeOffsetPath(y.last(t), this.ec)), offset: this.eo }
                  }
                }
              },
              {
        ...
        const kt = {
          ...
          createFromSelection: function () {
            ...
            if (f.isW3CRangeSupport) {
              ...
              var c = mt(l, !0),
                u = mt(s, !1)
              ht.isText(c.node) &&
                ht.isLeftEdgePoint(c) &&
                ht.isTextNode(u.node) &&
                ht.isRightEdgePoint(u) &&
          ...
          createFromNode: function (t) {
            var e = t,
              ...
              i = ht.nodeLength(n)
            return (
              ht.isVoid(e) && ((o = ht.listPrev(e).length - 1), (e = e.parentNode)),
              ht.isBR(n)
                ? ((i = ht.listPrev(n).length - 1), (n = n.parentNode))
                : ht.isVoid(n) && ((i = ht.listPrev(n).length), (n = n.parentNode)),
              this.create(e, o, n, i)
            )
          },
              ...
              },
              {
                ...
                value: function (t) {
                  null !== t.contents && this.$editable.html(t.contents),
                    null !== t.bookmark && kt.createFromBookmark(this.editable, t.bookmark).select()
                }
              },
              {
                key: 'rewind',
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'stylePara',
                value: function (t, o) {
                  e().each(t.nodes(ht.isPara, { includeAncestor: !0 }), function (t, n) {
                    e()(n).css(o)
                  })
                }
              },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    (n.anchor = t.isOnAnchor() && ht.ancestor(t.sc, ht.isAnchor)),
                    (n.ancestors = ht.listAncestor(t.sc, ht.isEditable)),
                    (n.range = t),
                    n
                  )
                }
                  ...
                  e().each(r, function (t, n) {
                    ...
                    if (ht.isLi(i)) {
                      ...
                      r
                        ...
                        : (o.wrapList(n, i.parentNode.nodeName),
                          n
                            .map(function (t) {
                              return t.parentNode
                            })
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  if (y.find(r, ht.isPurePara)) {
                    ...
                    var c = i.nodes(ht.isList, { includeAncestor: !0 }).filter(function (o) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    r && (ht.appendChildNodes(a, y.from(r.childNodes)), ht.remove(r)),
                    t
                  )
                }
              },
                      ...
                      if ('LI' === l.parentNode.nodeName)
                        r.map(function (t) {
                          ...
                          c.nextSibling
                            ...
                            e.length && (n.wrapList(e, l.nodeName), t.appendChild(e[0].parentNode))
                        }),
                        ...
                        var u =
                            l.childNodes.length > 1
                              ? ht.splitTree(
                                  l,
                                  { node: s.parentNode, offset: ht.position(s) + 1 },
                                  { isSkipPaddingBlankHTML: !0 }
                                )
                              : null,
                          d = ht.splitTree(
                            l,
                            { node: a.parentNode, offset: ht.position(a) },
                            { isSkipPaddingBlankHTML: !0 }
                          )
                        ;(r = o
                          ? ht.listDescendant(d, ht.isLi)
                          : y.from(d.childNodes).filter(ht.isLi)),
                          (!o && ht.isList(l.parentNode)) ||
                            (r = r.map(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  return t.previousSibling
                    ? ht.appendChildNodes(t.previousSibling, [t])
                    : this.wrapList([t], 'LI')
                }
              },
              {
                  ...
                  if (i) {
                    ...
                    if (
                      (1 === this.options.blockquoteBreakingLevel
                        ? (r = ht.ancestor(i, ht.isBlockquote))
                        : 2 === this.options.blockquoteBreakingLevel &&
                          (r = ht.lastAncestor(i, ht.isBlockquote)),
                      r)
                    ) {
                      ;(n = e()(ht.emptyPara)[0]),
                        ht.isRightEdgePoint(o.getStartPoint()) &&
                          ht.isBR(o.sc.nextSibling) &&
                          e()(o.sc.nextSibling).remove()
                      ...
                      ;(s = s.concat(ht.listDescendant(n, ht.isEmptyAnchor))),
                        e().each(s, function (t, e) {
                          ht.remove(e)
                        }),
                        (ht.isHeading(n) || ht.isPre(n) || ht.isCustomStyleTag(n)) &&
                          ht.isEmpty(n) &&
                          (n = ht.replace(n, 'p'))
                    }
                  } else {
        ...
        ;(Rt.where = { Row: 0, Column: 1 }),
          (Rt.requestAction = { Add: 0, Delete: 1 }),
          (Rt.resultAction = {
            Ignore: 0,
            SubtractSpanCount: 1,
            RemoveCell: 2,
                  ...
                  for (
                    ...
                    switch (c.action) {
                      ...
                      case Rt.resultAction.SumSpanCount:
                        if (
                          'top' === o &&
                          (c.baseCell.parent ? c.baseCell.closest('tr').rowIndex : 0) <=
                            i[0].rowIndex
                        ) {
                          var d = e()('<div></div>')
                ...
                value: function (t, o) {
                  ...
                  for (
                    ...
                    switch (s.action) {
                      case Rt.resultAction.AddCell:
                        'right' === o
                          ? e()(s.baseCell).after('<td' + l + '>' + ht.blank + '</td>')
              ...
              },
              {
                ...
                value: function (t) {
                  for (
                    var o = ht.ancestor(t.commonAncestor(), ht.isCell),
                      n = e()(o).closest('tr'),
                      i = n.children('td, th').index(e()(o)),
                      r = n[0].rowIndex,
                      a = new Rt(
                        o,
                        Rt.where.Row,
                        Rt.requestAction.Delete,
                        e()(n).closest('table')[0]
                      ).getActionList(),
                      s = 0;
                    s < a.length;
        ...
        var Ft = (function () {
          function t(o) {
            ...
            !(function (t, e) {
              ...
              (this.style = new Tt()),
              (this.table = new Lt()),
              (this.typing = new It(o)),
              (this.bullet = new $t()),
              (this.history = new xt(o)),
            ...
            ;(this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.insertNode = this.wrapCommand(function (t) {
                n.isLimited(e()(t).text().length) ||
                  ...
                  n.setLastRange(kt.createFromNodeAfter(t).select()))
              })),
              ...
              (this.createLink = this.wrapCommand(function (t) {
                ...
                if (!(l > 0 && n.isLimited(l))) {
                  ...
                  e().each(u, function (t, n) {
                    e()(n).attr('href', o),
                      r ? e()(n).attr('target', '_blank') : e()(n).removeAttr('target')
                  }),
              ...
              (this.floatMe = this.wrapCommand(function (t) {
                ...
                o.toggleClass('note-float-left', 'left' === t),
                  o.toggleClass('note-float-right', 'right' === t),
            ...
            (n = [
                ...
                value: function (t, e) {
                  return (
                    ...
                    (void 0 === e ||
                      !(
                        wt.isMove(e.keyCode) ||
                        wt.isNavigation(e.keyCode) ||
                        e.ctrlKey ||
                        e.metaKey ||
                        y.contains([wt.code.BACKSPACE, wt.code.DELETE], e.keyCode)
                      )) &&
              ...
              },
              {
                ...
                value: function (t) {
                  t
                    ? (this.lastRange = t)
                    : ((this.lastRange = kt.create(this.editable)),
                      0 === e()(this.lastRange.sc).closest('.note-editable').length &&
                        (this.lastRange = kt.createFromBodyElement(this.editable)))
                }
              },
              {
                key: 'getLastRange',
                  ...
                  e()
                    ...
                    .then(function (t) {
                      i.beforeCommand(),
                        'function' == typeof o
                          ? o(t)
                          : ('string' == typeof o && t.attr('data-filename', o),
                            t.css('width', Math.min(i.$editable.width(), t.width()))),
                        t.show(),
                        i.getLastRange().insertNode(t[0]),
                        i.setLastRange(kt.createFromNodeAfter(t[0]).select()),
                        i.afterCommand()
                    })
                    .fail(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e().each(t, function (t, n) {
                    var i = n.name
                    o.options.maximumImageFileSize && o.options.maximumImageFileSize < n.size
                      ? o.context.triggerEvent(
                          'image.upload.error',
                          o.lang.image.maximumFileSizeError
                        )
                      : (function (t) {
                          return e()
                            .Deferred(function (o) {
              ...
              },
              {
                ...
                value: function () {
                  var t = this.getLastRange()
                  return (
                    t.isOnAnchor() && (t = kt.createFromNode(ht.ancestor(t.sc, ht.isAnchor))),
                    t.toString()
                  )
                }
              },
              {
                ...
                value: function (t, o) {
                  if (
                    (document.execCommand('FormatBlock', !1, f.isMSIE ? '<' + t + '>' : t),
                    o &&
                      o.length &&
                      (o[0].tagName.toUpperCase() !== t.toUpperCase() && (o = o.find(t)),
                      o && o.length))
                  ) {
                ...
                value: function (t, o) {
                  ...
                  if ('' !== n) {
                    ...
                    if (
                      ...
                      r &&
                        !ht.nodeLength(r) &&
                        ((r.innerHTML = ht.ZERO_WIDTH_NBSP_CHAR),
                        kt.createFromNode(r.firstChild).select(),
                        this.setLastRange(),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (o && o.items && o.items.length) {
                    ...
                    'file' === n.kind && -1 !== n.type.indexOf('image/')
                      ? (this.context.invoke('editor.insertImagesOrCallback', [n.getAsFile()]),
                        t.preventDefault())
                      : 'string' === n.kind &&
                        this.context.invoke('editor.isLimited', o.getData('Text').length) &&
                        t.preventDefault()
                ...
                value: function () {
                  ...
                  ;(this.documentEventHandlers.onDragenter = function (e) {
                    ...
                    (this.documentEventHandlers.onDragleave = function (n) {
                      ;((o = o.not(n.target)).length && 'BODY' !== n.target.nodeName) ||
                      ...
                      .on('drop', function (o) {
                        ...
                        o.preventDefault(),
                          n && n.files && n.files.length
                            ? (t.$editable.focus(),
                              t.context.invoke('editor.insertImagesOrCallback', n.files))
                            : e().each(n.types, function (o, i) {
                                if (!(i.toLowerCase().indexOf('_moz_') > -1)) {
                                  var r = n.getData(i)
                                  i.toLowerCase().indexOf('text') > -1
                                    ? t.context.invoke('editor.pasteHTML', r)
                                    : e()(r).each(function (e, o) {
            ...
            (o = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.purify(
                      ht.value(this.$codable, this.options.prettifyHtml) || ht.emptyPara
                    ),
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.lastWordRange) {
                      ...
                      if (o && (o[1] || o[2])) {
                        var n = o[1] ? t : 'http://' + t,
                          i = this.options.showDomainOnlyForAutolink
                            ? t
                                .replace(
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                key: 'handleKeydown',
                value: function (t) {
                  if (this.previousKeydownCode && y.contains(this.keys, this.previousKeydownCode))
            ...
            (n = [
              {
                ...
                value: function (t) {
                  ...
                  return this.options.shortcuts && e
                    ? (f.isMac && (e = e.replace('CMD', '⌘').replace('SHIFT', '⇧')),
                      ' (' +
                        (e = e
                          .replace('BACKSLASH', '\\')
                          .replace('SLASH', '/')
                  ...
                  return (
                    Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) ||
                      (this.fontInstalledMap[t] =
                        f.isFontInstalled(t) || y.contains(this.options.fontNamesIgnoreCheck, t)),
                    this.fontInstalledMap[t]
                  )
                }
              },
                      ...
                      children: [
                        this.button({
                          ...
                          callback: function (t) {
                            ...
                            n &&
                              (e.css('background-color', r.options.colorButton.backColor),
                              t.attr('data-backColor', r.options.colorButton.backColor)),
                              i
                                ? (e.css('color', r.options.colorButton.foreColor),
                                  t.attr('data-foreColor', r.options.colorButton.foreColor))
                        ...
                        t.ui.dropdown({
                          ...
                          template: function (e) {
                            'string' == typeof e &&
                              (e = {
                                tag: e,
                                title: Object.prototype.hasOwnProperty.call(t.lang.style, e)
                                  ? t.lang.style[e]
                                  : e
                              })
                            var o = e.tag,
                    ...
                    this.context.memo('button.fontname', function () {
                      ...
                      return (
                        t.options.addDefaultFonts &&
                          e().each(o['font-family'].split(','), function (e, o) {
                            ;(o = o.trim().replace(/['"]+/g, '')),
                      ...
                      return t.ui
                        .buttonGroup([
                          ...
                          t.ui.dropdownCheck({
                            ...
                            click:
                              t.context.createInvokeHandlerAndUpdateState('editor.fontSizeUnit')
                          })
                        ])
                        .render()
                    }),
                    ...
                    this.context.memo('button.ul', function () {
                      return t
                        .button({
                          ...
                          tooltip:
                            t.lang.lists.unordered + t.representShortcut('insertUnorderedList'),
                    ...
                    this.context.memo('button.paragraph', function () {
                      return t.ui
                        .buttonGroup([
                          ...
                          t.ui.dropdown([
                            t.ui.buttonGroup({ className: 'note-align', children: [r, a, s, l] }),
                            t.ui.buttonGroup({ className: 'note-list', children: [c, u] })
                          ])
                        ])
                        .render()
                    }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.options.otherStaticBar &&
                    (r = e()(this.options.otherStaticBar).outerHeight())
                  ...
                  !this.isFollowing && a > l && a < c - n
                    ? ((this.isFollowing = !0),
                      ...
                      this.$toolbar.css({ position: 'fixed', top: r, width: o, zIndex: 1e3 }))
                    : this.isFollowing &&
                      (a < l || a > c) &&
                      ((this.isFollowing = !1),
                      this.$toolbar.css({
        ...
        var ce = (function () {
          function t(o) {
            !(function (t, e) {
              ...
              (this.options = o.options),
              (this.lang = this.options.langInfo),
              o.memo('help.linkDialog.show', this.options.langInfo.help['linkDialog.show'])
          }
          var o, n, i
          return (
            (o = t),
                    ...
                    .Deferred(function (e) {
                      ...
                      o.ui.onDialogShown(o.$dialog, function () {
                        o.context.triggerEvent('dialog.shown'),
                          ...
                          o.toggleLinkBtn(r, n, i),
                          o.bindEnterKey(i, r),
                          o.bindEnterKey(n, r)
                        var l =
                          void 0 !== t.isNewWindow
                            ? t.isNewWindow
                            : o.context.options.linkTargetBlank
                        a.prop('checked', l)
                ...
                value: function () {
                  ...
                  if (this.options.maximumImageFileSize) {
                    var e = Math.floor(
                      ...
                      o =
                        1 * (this.options.maximumImageFileSize / Math.pow(1024, e)).toFixed(2) +
                        ' ' +
                        ' KMGTP'[e] +
                        'B'
                ...
                value: function (t, o) {
                  if (ht.isImg(t)) {
                    ...
                    this.options.popatmouse
                      ? ((r.left = o.pageX - 20), (r.top = o.pageY))
                      : (r = n),
                      (r.top -= i.top),
                      (r.left -= i.left),
                      this.$popover.css({ display: 'block', left: r.left, top: r.top })
                  } else this.hide()
                }
              },
              {
                ...
                value: function (t) {
                  ...
                  if (n && 11 === n[1].length) {
                    ...
                    if (void 0 !== n[2]) {
                      ...
                      if (k)
                        for (var y = [3600, 60, 1], w = 0, C = y.length; w < C; w++)
                          b += void 0 !== k[w + 1] ? y[w] * parseInt(k[w + 1], 10) : 0
                    }
                    o = e()('<iframe>')
                      .attr('frameborder', 0)
                    ...
                    o = e()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                      .attr('frameborder', 0)
                    ...
                    o = e()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                      ...
                      .attr(
                        'src',
                        'https://v.qq.com/txp/iframe/player.html?vid=' + N + '&amp;auto=0'
                      )
                  } else if (f || p || v)
                    o = e()('<video controls>')
                      .attr('src', t)
            ...
            !(function (t, e) {
              ...
              (this.events = {
                'summernote.contextmenu': function (t) {
                  n.options.editing &&
                    (t.preventDefault(), t.stopPropagation(), (n.onContextmenu = !0), n.update(!0))
                },
                'summernote.mousedown': function (t, e) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  ;(this.lastWordRange = null),
                    ...
                    this.$content.on('click', '.note-hint-item', function (o) {
                      t.$content.find('.active').removeClass('active'),
                        e()(o.currentTarget).addClass('active'),
                        t.replace()
                    }),
                    this.$popover.on('mousedown', function (t) {
                      t.preventDefault()
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  return o.map(function (o) {
                    ...
                    return (
                      i.append(n.template ? n.template(o) : o + ''),
          ...
          function t(o, n) {
            if (
              ...
              (this.options = e().extend(
                {},
                { title: '', target: n.container, trigger: 'hover focus', placement: 'bottom' },
                n
              )),
              (this.$tooltip = e()(
                [
              ...
              this.options.trigger.split(' ').forEach(function (t) {
                'hover' === t
                  ? (o.off('mouseenter mouseleave'), o.on('mouseenter', i).on('mouseleave', r))
                  : 'click' === t
                  ? o.on('click', a)
                  : 'focus' === t && o.on('focus', i).on('blur', r)
              })
            }
          }
          var o, n, i
            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  var s = t.outerWidth(),
                    ...
                    u = i.outerHeight()
                  'bottom' === a
                    ? i.css({ top: o.top + l, left: o.left + (s / 2 - c / 2) })
                    : 'top' === a
                    ? i.css({ top: o.top - u, left: o.left + (s / 2 - c / 2) })
                    : 'left' === a
                    ? i.css({ top: o.top + (l / 2 - u / 2), left: o.left - c })
                    : 'right' === a && i.css({ top: o.top + (l / 2 - u / 2), left: o.left + s }),
                    i.addClass('in')
                }
              },
              {
        ...
        var Ae = (function () {
          function t(o, n) {
            !(function (t, e) {
              ...
              (this.$button = o),
              (this.options = e().extend({}, { target: n.container }, n)),
              this.setEvent()
          }
          var o, n, i
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  o.left + n > i - r
                    ? t.css('margin-left', i - r - (o.left + n))
                    : t.css('margin-left', '')
                }
              },
              {
        ...
        e()(document).on('click', function (t) {
          e()(t.target).closest('.note-btn-group').length ||
            ...
            e()('.note-btn-group .note-btn.active').removeClass('active'))
        }),
          e()(document).on('click.note-dropdown-menu', function (t) {
            e()(t.target).closest('.note-dropdown-menu').parent().removeClass('open'),
              e()(t.target)
        ...
        const He = (function () {
          function t(o) {
            !(function (t, e) {
              ...
              (this.$modal = o),
              (this.$backdrop = e()('<div class="note-modal-backdrop"></div>'))
          }
          var o, n, i
          return (
            (o = t),
        ...
        var Be = Ie('<div class="note-editor note-frame"></div>'),
          ...
          qe = Ie(
            ...
            function (t, o) {
              o &&
                ...
                t
                  .data('_lite_tooltip', new Re(t, { title: o.tooltip, container: o.container }))
                  .on('click', function (t) {
                ...
                o &&
                  ...
                  t.data('_lite_dropdown', new Fe(t, { container: o.container })),
          ...
          Qe = function (t) {
            return Ve([
              ...
              _e([
                Ve({ className: 'note-align', children: t.items[0] }),
                Ve({ className: 'note-list', children: t.items[1] })
              ])
            ]).render()
          },
          Je = function (t) {
            return Ve(
              ...
              {
                callback: function (o) {
                  o.find('.note-dimension-picker-mousecatcher')
          ...
          to = Ie('<div class="note-color-palette"></div>', function (t, o) {
            ...
            t.html(n.join('')),
              t.find('.note-color-btn').each(function () {
                e()(this).data('_lite_tooltip', new Re(e()(this), { container: o.container }))
              })
          }),
          eo = function (t, o) {
            return Ve({
              ...
              children: [
                qe({
                  ...
                  callback: function (t) {
                    var e = t.find('.note-recent-color')
                    'foreColor' !== o &&
                      (e.css('background-color', '#FFFF00'), t.attr('data-backColor', '#FFFF00'))
                  }
                }),
                qe({
                  className: 'dropdown-toggle',
                ...
                _e({
                  items: [
                    ...
                    '<div class="note-palette-title">' + t.lang.color.background + '</div>',
                    '<div>',
                    ...
                    '<div class="note-palette-title">' + t.lang.color.foreground + '</div>',
                    '<div>',
                  ...
                  callback: function (n) {
                    n.find('.note-holder').each(function () {
                      ...
                      'fore' === o
                        ? (n.find('.btn-background-color').hide(), n.css({ 'min-width': '210px' }))
                        : 'back' === o &&
                          (n.find('.btn-foreground-color').hide(), n.css({ 'min-width': '210px' }))
                  },
                  click: function (n) {
                    var i = e()(n.target),
                      r = i.data('event'),
              ...
              e.fade && t.addClass('fade'),
                ...
                t.html(
                  [
                    ...
                    e.footer ? '<div class="note-modal-footer">' + e.footer + '</div>' : '',
                    '</div>'
                  ].join('')
                ),
                t.data('modal', new He(t, e))
            }
          ),
          no = function (t) {
            var e =
          ...
          so = Ie('<div class="checkbox"></div>', function (t, e) {
            t.html(
              [
                ...
                '<input role="checkbox" type="checkbox"' + (e.id ? ' id="note-' + e.id + '"' : ''),
                e.checked ? ' checked' : '',
