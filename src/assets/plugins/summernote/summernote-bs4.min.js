      ...
      (() => {
        ...
        function U(t) {
          ...
          return (
            ...
            !(!k.all(t.childNodes, S) || '' !== t.innerHTML)
          )
        }
        function j(t) {
        ...
        function et(t, e) {
          ...
          if (0 === t.offset) {
            ...
            tt(t.node)
              ? (o = O((n = t.node.childNodes[t.offset - 1])))
        ...
        function nt(t, e) {
          ...
          if (O(t.node) === t.offset) {
            ...
            tt(t.node)
              ...
              : ((n = t.node), (o = e ? O(t.node) : t.offset + 1))
          return { node: n, offset: o }
        }
        function ot(t, e) {
          var n,
            o = 0
          if (U(t.node))
            return null === t.node ? null : { node: (n = t.node.nextSibling), offset: (o = 0) }
          if (O(t.node) === t.offset) {
            if (C(t.node)) return null
            ;(n = t.node.parentNode),
              (o = J(t.node) + 1),
              C(n) && ((n = t.node.nextSibling), (o = 0))
          } else if (tt(t.node)) {
            if (((o = 0), U((n = t.node.childNodes[t.offset]))))
              return U(t.node.nextSibling) ? null : { node: t.node.nextSibling, offset: o }
        ...
        function at(t, e) {
          ...
          return (
            _(a, V(r)),
            n || (j(t.node), j(a)),
            i && (U(t.node) && ct(t.node), U(a)) ? (ct(a), t.node.nextSibling) : a
          )
        }
        function st(t, e, n) {
        ...
        const ht = {
          ...
          withClosestSiblings: function (t, e) {
            ...
            var n = []
            return (
              t.previousSibling && e(t.previousSibling) && n.push(t.previousSibling),
              n.push(t),
          ...
          splitPoint: function (t, e) {
            ...
            return (
              s || o !== t.node || (s = t.node.childNodes[t.offset]), { rightNode: s, container: o }
            )
          },
          create: lt,
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  var n = e()(t).height()
                  return (
                    t.scrollTop + n < this.sc.offsetTop &&
                      (t.scrollTop += Math.abs(t.scrollTop + n - this.sc.offsetTop)),
                    this
                  )
                }
              },
                        ...
                        ht.isEditable(e.node) ||
                          (o
                            ? (ht.isLeftEdgePoint(e) && s.push(e.node),
                              ht.isRightEdgePoint(e) && k.contains(s, e.node) && (i = e.node))
                            : (i = n ? ht.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i))
                      },
                      !0
                    ),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e && (n = ht.nextPointUntil(n, o)), new t(i.node, i.offset, n.node, n.offset)
                  )
                }
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  return {
                    s: { path: k.tail(ht.makeOffsetPath(k.head(t), this.sc)), offset: this.so },
                    e: { path: k.tail(ht.makeOffsetPath(k.last(t), this.ec)), offset: this.eo }
                  }
                }
              },
              {
        ...
        const yt = {
          ...
          createFromNode: function (t) {
            ...
            return (
              ...
              ht.isBR(o)
                ? ((i = ht.listPrev(o).length - 1), (o = o.parentNode))
                : ht.isVoid(o) && ((i = ht.listPrev(o).length), (o = o.parentNode)),
              this.create(e, n, o, i)
            )
          },
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    (o.anchor = t.isOnAnchor() && ht.ancestor(t.sc, ht.isAnchor)),
                      ...
                      if ('LI' === l.parentNode.nodeName)
                        r.map(function (t) {
                          ...
                          c.nextSibling
                            ...
                            e.length && (o.wrapList(e, l.nodeName), t.appendChild(e[0].parentNode))
                        }),
                        ...
                        ;(r = n
                          ...
                          : k.from(d.childNodes).filter(ht.isLi)),
                ...
                value: function (t, n) {
                  ...
                  if (i) {
                    ...
                    if (
                      ...
                      ;(o = e()(ht.emptyPara)[0]),
                        ht.isRightEdgePoint(n.getStartPoint()) &&
                          ht.isBR(n.sc.nextSibling) &&
                          e()(n.sc.nextSibling).remove()
                      ...
                      ;(s = s.concat(ht.listDescendant(o, ht.isEmptyAnchor))),
                        ...
                        (ht.isHeading(o) || ht.isPre(o) || ht.isCustomStyleTag(o)) &&
                          ht.isEmpty(o) &&
                          (o = ht.replace(o, 'p'))
                    }
                  } else {
              ...
              (this.createLink = this.wrapCommand(function (t) {
                ...
                if (!(l > 0 && o.isLimited(l))) {
                  ...
                  'string' == typeof n && (n = n.trim()),
                    o.options.onCreateLink
                      ? (n = o.options.onCreateLink(n))
                      : a &&
                        (n = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(n)
                          ? n
                          : o.options.defaultProtocol + n)
                  var u = []
                  if (c) {
            ...
            (o = [
                  ...
                  return (
                    ...
                    (void 0 === e ||
                      !(
                        ...
                        e.ctrlKey ||
                        e.metaKey ||
                        k.contains([wt.code.BACKSPACE, wt.code.DELETE], e.keyCode)
                      )) &&
              ...
              },
              {
                ...
                value: function (t) {
                  t
                    ? (this.lastRange = t)
                    : ((this.lastRange = yt.create(this.editable)),
                      0 === e()(this.lastRange.sc).closest('.note-editable').length &&
                        (this.lastRange = yt.createFromBodyElement(this.editable)))
                }
              },
              {
                key: 'getLastRange',
                  ...
                  e()
                    ...
                    .then(function (t) {
                      i.beforeCommand(),
                        'function' == typeof n
                          ? n(t)
                          : ('string' == typeof n && t.attr('data-filename', n),
              ...
              },
              {
                ...
                value: function () {
                  var t = this.getLastRange()
                  return (
                    t.isOnAnchor() && (t = yt.createFromNode(ht.ancestor(t.sc, ht.isAnchor))),
                    t.toString()
                  )
                }
              },
              {
                ...
                value: function (t, n) {
                  if (
                    ...
                    n &&
                      n.length &&
                      (n[0].tagName.toUpperCase() !== t.toUpperCase() && (n = n.find(t)),
                      n && n.length))
                  ) {
                ...
                value: function (t) {
                  ...
                  if (n && n.items && n.items.length) {
                    ...
                    'file' === o.kind && -1 !== o.type.indexOf('image/')
                      ? (this.context.invoke('editor.insertImagesOrCallback', [o.getAsFile()]),
                        t.preventDefault())
                      : 'string' === o.kind &&
                ...
                value: function () {
                  ...
                  ;(this.documentEventHandlers.onDragenter = function (e) {
                    ...
                    (this.documentEventHandlers.onDragleave = function (o) {
                      ;((n = n.not(o.target)).length && 'BODY' !== o.target.nodeName) ||
                      ...
                      .on('drop', function (n) {
                        ...
                        n.preventDefault(),
                          o && o.files && o.files.length
                            ? (t.$editable.focus(),
                              t.context.invoke('editor.insertImagesOrCallback', o.files))
                      ...
                      if (ht.isControlSizing(e.target)) {
                        ...
                        var n = t.$handle.find('.note-control-selection').data('target'),
                          ...
                          r = function (e) {
                            t.context.invoke(
                              'editor.resizeTo',
                              { x: e.clientX - o.left, y: e.clientY - (o.top - i) },
                              n,
                              !e.shiftKey
                            ),
                              t.update(n[0], e)
                  ...
                  return (
                    Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) ||
                      (this.fontInstalledMap[t] =
                        f.isFontInstalled(t) || k.contains(this.options.fontNamesIgnoreCheck, t)),
                    this.fontInstalledMap[t]
                  )
                }
              },
                ...
                value: function () {
                  ...
                  !this.isFollowing && a > l && a < c - o
                    ? ((this.isFollowing = !0),
                      ...
                      this.$toolbar.css({ position: 'fixed', top: r, width: n, zIndex: 1e3 }))
                    : this.isFollowing &&
                      (a < l || a > c) &&
                      ((this.isFollowing = !1),
                      this.$toolbar.css({
                      ...
                      n.ui.onDialogShown(n.$dialog, function () {
                        ...
                        var l =
                          void 0 !== t.isNewWindow
                            ? t.isNewWindow
                            : n.context.options.linkTargetBlank
                        a.prop('checked', l)
                ...
                value: function (t, n) {
                  if (ht.isImg(t)) {
                    ...
                    this.options.popatmouse
                      ? ((r.left = n.pageX - 20), (r.top = n.pageY))
                      : (r = o),
                      (r.top -= i.top),
                      (r.left -= i.left),
                ...
                value: function (t) {
                  ...
                  if (o && 11 === o[1].length) {
                    ...
                    n = e()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                      ...
                      .attr(
                        'src',
                        'https://v.qq.com/txp/iframe/player.html?vid=' + $ + '&amp;auto=0'
                      )
                  } else if (f || p || m)
                    n = e()('<video controls>')
                      .attr('src', t)
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  return n.map(function (n) {
                    ...
                    return (
                      i.append(o.template ? o.template(n) : n + ''),
                      i.data({ index: t, item: n }),
                      i
                    )
                  })
                }
        ...
        var Re = Ne('<div class="note-editor note-frame card"></div>'),
          ...
          Ve = Ne('<div class="form-check"></div>', function (t, e) {
            t.html(
              [
                '<label class="form-check-label"' + (e.id ? ' for="note-' + e.id + '"' : '') + '>',
        ...
        ;(e().summernote = e().extend(e().summernote, {
          ...
          (e().summernote.options.styleTags = [
            'p',
            {
              title: 'Blockquote',
              tag: 'blockquote',
