  ...
  return /******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
      /***/ 9770: /***/ (
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(
          jquery__WEBPACK_IMPORTED_MODULE_0___default().summernote.lang,
          {
            'en-US': {
              font: {
                bold: 'Bold',
    ...
    ;(() => {
      ...
      function validFontName(fontName) {
        return external_jQuery_default().inArray(fontName.toLowerCase(), genericFontFamilies) === -1
          ? "'".concat(fontName, "'")
          : fontName
      }
      ...
      var isSupportTouch =
        'ontouchstart' in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 // [workaround] IE doesn't have input events for contentEditable
      ...
      function walkPoint(startPoint, endPoint, handler, isSkipInnerOffset) {
        ...
        while (point) {
          ...
          var isSkipOffset =
            isSkipInnerOffset && startPoint.node !== point.node && endPoint.node !== point.node
      ...
      var Context = /*#__PURE__*/ (function () {
        ...
        function Context($note, options) {
          ...
          external_jQuery_default().summernote.ui =
            external_jQuery_default().summernote.ui_template(this.options)
            ...
            value: function normalize() {
              ...
              var getVisiblePoint = function getVisiblePoint(point, isLeftToRight) {
                ...
                if (!hasLeftNode) {
                  ...
                  hasLeftNode =
                    (dom.isRightEdgePointOf(point, block) || dom.isVoid(_nextPoint.node)) &&
                    isLeftToRight
                }
      ...
      /* harmony default export */ const key = {
        ...
        isEdit: function isEdit(keyCode) {
          return lists.contains(
            [KEY_MAP.BACKSPACE, KEY_MAP.TAB, KEY_MAP.ENTER, KEY_MAP.SPACE, KEY_MAP.DELETE],
            keyCode
          )
        },
          ...
          },
          {
            ...
            value: function current(rng) {
              ...
              if (para && para.style['line-height']) {
                ...
                var lineHeight =
                  parseInt(styleInfo['line-height'], 10) / parseInt(styleInfo['font-size'], 10)
      ...
      var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
        ...
        function addCellInfoToVirtual(row, cell) {
          ...
          var isThisSelectedCell =
            row.rowIndex === _startPoint.rowPos && cell.cellIndex === _startPoint.colPos
          ...
          },
          {
            ...
            value: function addRow(rng, position) {
              ...
              var vTable = new TableResultAction(
                ...
                external_jQuery_default()(currentTr).closest('table')[0]
              )
                  ...
                  case TableResultAction.resultAction.SumSpanCount:
                    {
                      if (position === 'top') {
                        ...
                        if (isTopFromRowSpan) {
                          var newTd = external_jQuery_default()('<div></div>')
                            .append(
                              external_jQuery_default()(
              ...
              if (position === 'top') {
                ...
                if (cellHasRowspan) {
                  ...
                  external_jQuery_default()(
                    external_jQuery_default()(currentTr).parent().find('tr')[lastTrIndex]
          ...
          },
          {
            ...
            value: function addCol(rng, position) {
              ...
              var vTable = new TableResultAction(
                ...
                TableResultAction.requestAction.Add,
                external_jQuery_default()(row).closest('table')[0]
              )
              var actions = vTable.getActionList()
              ...
              for (var actionIndex = 0; actionIndex < actions.length; actionIndex++) {
                ...
                switch (currentCell.action) {
                  case TableResultAction.resultAction.AddCell:
                    if (position === 'right') {
                      external_jQuery_default()(currentCell.baseCell).after(
                        '<td' + tdAttributes + '>' + dom.blank + '</td>'
                      )
                    } else {
                      external_jQuery_default()(currentCell.baseCell).before(
                        '<td' + tdAttributes + '>' + dom.blank + '</td>'
                      )
                    }
          ...
          },
          {
            ...
            value: function setLastRange(rng) {
              if (rng) {
                ...
                if (
                  external_jQuery_default()(this.lastRange.sc).closest('.note-editable').length ===
                  0
                ) {
            ...
            value: function pasteByEvent(event) {
              ...
              if (clipboardData && clipboardData.items && clipboardData.items.length) {
                ...
                if (item.kind === 'file' && item.type.indexOf('image/') !== -1) {
                  ...
                  if (
                    this.context.invoke('editor.isLimited', clipboardData.getData('Text').length)
                  ) {
                    event.preventDefault()
                  }
                }
            ...
            value: function purify(value) {
              if (this.options.codeviewFilter) {
                ...
                if (this.options.codeviewIframeFilter) {
                  var whitelist = this.options.codeviewIframeWhitelistSrc.concat(
            ...
            value: function initialize() {
              ...
              this.$statusbar.on('mousedown', function (event) {
                ...
                var onMouseMove = function onMouseMove(event) {
                  ...
                  height =
                    _this.options.minheight > 0 ? Math.max(height, _this.options.minheight) : height
                  height =
                    _this.options.maxHeight > 0 ? Math.min(height, _this.options.maxHeight) : height
                  heightCode =
                    _this.options.minheight > 0
                      ? Math.max(heightCode, _this.options.minheight)
                      : heightCode
                  heightCode =
                    _this.options.maxHeight > 0
                      ? Math.min(heightCode, _this.options.maxHeight)
                      : heightCode
                  ...
                  children: [
                    ...
                    this.ui.dropdown({
                      ...
                      callback: function callback($dropdown) {
                        ...
                        $dropdown.find('input[type=color]').each(function (idx, item) {
                          external_jQuery_default()(item).change(function () {
                            var $chip = $dropdown
                              .find('#' + external_jQuery_default()(this).data('event'))
                              .find('.note-color-btn')
                              .first()
                      ...
                      click: function click(event) {
                        event.stopPropagation()
                        var $parent = external_jQuery_default()('.' + className).find(
                          '.note-dropdown-menu'
                        )
                        ...
                        if (eventName === 'openPalette') {
                          ...
                          var $palette = external_jQuery_default()(
                            $parent.find('#' + $picker.data('event')).find('.note-color-row')[0]
                          ) // Shift palette chips
                    ...
                    _this2.ui.dropdown({
                      ...
                      template: function template(item) {
                        ...
                        if (typeof item === 'string') {
                          item = {
                            tag: item,
                            title: Object.prototype.hasOwnProperty.call(_this2.lang.style, item)
              ...
              this.context.memo('button.strikethrough', function () {
                return _this2
                  .button({
                    ...
                    tooltip:
                      _this2.lang.font.strikethrough + _this2.representShortcut('strikethrough'),
              ...
              this.context.memo('button.ul', function () {
                return _this2
                  .button({
                    ...
                    tooltip:
                      _this2.lang.lists.unordered + _this2.representShortcut('insertUnorderedList'),
              ...
              this.context.memo('button.ol', function () {
                return _this2
                  .button({
                    ...
                    tooltip:
                      _this2.lang.lists.ordered + _this2.representShortcut('insertOrderedList'),
                    ...
                    ],
                    {
                      callback: function callback($node) {
                        ...
                        $catcher
                          ...
                          .mouseup(_this2.context.createInvokeHandler('editor.insertTable'))
                          .on('mousemove', _this2.tableMoveHandler.bind(_this2))
                      }
                    }
                  )
                  .render()
              ...
              this.context.memo('button.hr', function () {
                return _this2
                  .button({
                    ...
                    tooltip:
                      _this2.lang.hr.insert + _this2.representShortcut('insertHorizontalRule'),
            ...
            value: function updateCurrentStyle($container) {
              ...
              if (styleInfo['line-height']) {
                ...
                $cont.find('.dropdown-line-height a').each(function (idx, item) {
                  ...
                  var isChecked =
                    external_jQuery_default()(item).data('value') + '' === lineHeight + ''
                  $item.toggleClass('checked', isChecked)
                })
        ...
        ImageDialog_createClass(ImageDialog, [
          {
            ...
            value: function initialize() {
              ...
              if (this.options.maximumImageFileSize) {
                ...
                var readableSize =
                  (this.options.maximumImageFileSize / Math.pow(1024, unit)).toFixed(2) * 1 +
                  ' ' +
                  ' KMGTP'[unit] +
                  'B'
        ...
        TablePopover_createClass(TablePopover, [
          ...
          },
          {
            ...
            value: function update(target) {
              ...
              var isCell =
                dom.isCell(target) ||
                dom.isCell(target === null || target === void 0 ? void 0 : target.parentElement)
            ...
            value: function createVideoNode(url) {
              ...
              if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = external_jQuery_default()('<iframe>')
                  ...
                  .attr(
                    'src',
                    '//www.youtube.com/embed/' + youtubeId + (start > 0 ? '?start=' + start : '')
                  )
                  .attr('width', '640')
                  .attr('height', '360')
                ...
                $video = external_jQuery_default()('<video controls>')
                  .attr('src', url)
                  .attr('width', '640')
                  .attr('height', '360')
            ...
            value: function createShortcutList() {
              ...
              return Object.keys(keyMap)
                .map(function (key) {
                  ...
                  $row
                    .append(
                      external_jQuery_default()('<label><kbd>' + key + '</kdb></label>').css({
                        width: 180,
                        'margin-right': 10
                      })
                    )
                    .append(
                      external_jQuery_default()('<span></span>').html(
        ...
        function AirPopover(context) {
          ...
          this.events = {
            ...
            'summernote.keyup summernote.mouseup summernote.scroll':
              function summernoteKeyupSummernoteMouseupSummernoteScroll(we, e) {
      ...
      external_jQuery_default().summernote = external_jQuery_default().extend(
      ...
      var TooltipUI = /*#__PURE__*/ (function () {
        function TooltipUI($node, options) {
          ...
          this.$tooltip = external_jQuery_default()(
            [
      ...
      /* harmony default export */ const js_TooltipUI = TooltipUI // CONCATENATED MODULE: ./src/styles/lite/js/DropdownUI.js
          ...
          },
          {
            ...
            value: function show() {
              ...
              var targetMarginRight = parseFloat(
                external_jQuery_default()(this.options.target).css('margin-right')
              )
      ...
      external_jQuery_default()(document).on('click.note-dropdown-menu', function (e) {
        external_jQuery_default()(e.target)
      ...
      /* harmony default export */ const js_DropdownUI = DropdownUI // CONCATENATED MODULE: ./src/styles/lite/js/ModalUI.js
      ...
      /* harmony default export */ const js_ModalUI = ModalUI // CONCATENATED MODULE: ./src/styles/lite/summernote-lite.js
      ...
      var summernote_lite_button = renderer.create(
        ...
        function ($node, options) {
          var markup = Array.isArray(options.items)
            ? options.items.map(function (item) {
                ...
                var $temp = external_jQuery_default()(
      ...
      var palette = renderer.create(
        ...
        function ($node, options) {
          ...
          $node.find('.note-color-btn').each(function () {
            external_jQuery_default()(this).data(
              '_lite_tooltip',
              new js_TooltipUI(external_jQuery_default()(this), {
                container: options.container
              })
            )
          })
      ...
      var summernote_lite_checkbox = renderer.create(
