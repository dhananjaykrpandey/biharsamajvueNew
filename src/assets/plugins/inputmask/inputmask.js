                        ...
                        y[l] !== b[l] &&
                          ...
                          ((b[l] !== s || b[l + 1] !== k) && b[l] !== k)
                            ? b[l + 1] === k && b[l] === y[l + 1]
                              ...
                              : y[l] !== s &&
                                y[l] !== k &&
                                (y[l + 1] === k || (b[l] !== y[l] && b[l + 1] === y[l + 1]))
                              ? ((m = 'insertReplacementText'), g.push(y[l]), r.begin--)
                              : y[l] === k
                              ? ((m = 'deleteContentBackward'),
                                (n.isMask.call(t, n.translatePosition.call(t, l), !0) ||
                                  b[l] === i.radixPoint) &&
                                  r.end++)
                              : (l = o)
                            : ((m = 'insertText'), g.push(y[l]), r.begin--, r.end--))
              ...
              postValidation: function (e, t, i, a, n, r, o, s) {
                ...
                if (
                  ...
                  if (
                    ...
                    for (
                      var p = l.getMaskTemplate.call(this, !1, 1, void 0, !0), h = t + 1;
                      h < e.length;
                      h++
                    )
            ...
            numeric: {
              ...
              onBeforeWrite: function (e, t, i, a) {
                ...
                if (
                  ...
                  for (
                    var u =
                        t.join('').lastIndexOf(l[0].split('').reverse().join('')) -
                        (l[0] == l.input ? 0 : 1),
                      f = l[0] == l.input ? 1 : 0,
                      d = l[0].length - f;
                    d > 0;
                  ...
                  if (!0 === a._radixDance) {
                    ...
                    if (a.digitsOptional) {
                      ...
                      return (
                        ...
                        l.trigger('setvalue', [r, i.begin >= r.length ? f + 1 : i.begin]),
                        !1
                      )
                  }
                }
            ...
            (t.unmaskedvalue = function (e) {
              ...
              for (var l in r)
                r[l] &&
                  r[l].match &&
                  (1 != r[l].match.static ||
                    (Array.isArray(a.metadata) && !0 !== r[l].generatedInput)) &&
                  n.push(r[l].input)
          ...
          function d(e, t, i, a, n) {
            ...
            t &&
              p.call(
                ...
                n &&
                  (('input' === n.type && s.undoValue !== o.getBuffer.call(s).join('')) ||
                    'paste' === n.type)
              ),
          ...
          ;(y.prototype = {
            ...
            mask: function (e) {
              ...
              return (
                ...
                (e = e.nodeName ? [e] : Array.isArray(e) ? e : Array.from(e)).forEach(function (
                  e,
                  i
                ) {
        ...
        8711: function (e, t, i) {
          ...
          function s(e, t, i) {
            ...
            for (
              ...
              ((!0 === t &&
                (!0 !== a.getTest.call(n, r).match.newBlockMarker || !l.call(n, r, void 0, !0))) ||
                  ...
                  if (r.isGroup && u !== r) {
                    ...
                    if (-1 === C || 'string' == typeof C) {
                      ...
                      for (var N = 0; N < B.length; N++) {
                        ;(A = parseInt(B[N])),
                          (m = []),
                          (i = ('string' == typeof C && v(h, A, O)) || j.slice())
                        var V = _.matches[A]
                        if (V && l(V, [A].concat(o), u)) r = !0
                        else if (
                          (0 === N && (T = !0),
                          V && V.matches && V.matches.length > _.matches[0].matches.length)
                        )
                          break
                        ;(S = m.slice()), (h = D), (m = [])
                    ...
                    for (
                      ...
                      if ((r = l(W, [z].concat(o), W))) {
                        ...
                        return (
                          a.jit && (s.jitOffset[e] = W.matches.length - W.matches.indexOf(a)), !0
                        )
                      }
                    }
          ...
          function m(e, t, i, a) {
            ...
            if (
              ...
              var b,
                ...
                E = P
              for (
                t && ((l.validPositions[a] = u.extend(!0, {}, t)), E++, P++), g = t ? v : v - 1;
                g <= y;
                g++
              ) {
                if (
              ...
              if (!m)
                return (l.validPositions = u.extend(!0, {}, k)), o.resetMaskSet.call(r, !0), !1
            } else
              t &&
