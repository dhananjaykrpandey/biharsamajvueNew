...
;(function () {
  ...
  var SearchPane = /** @class */ (function () {
    ...
    function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
      ...
      this.dom = {
        ...
        container: $('<div/>')
          ...
          .addClass(this.classes.layout + (layVal < 10 ? layout : layout.split('-')[0] + '-9')),
        ...
        searchButton: $(
          '<button type = "button" class="' + this.classes.searchIcon + '"></button>'
        ).addClass(this.classes.paneButton),
    ...
    SearchPane.prototype.adjustTopRow = function () {
      var subContainers = this.dom.container.find(
      ...
      if (
        ($(subContainers[0]).width() < 252 || $(topRow[0]).width() < 252) &&
        $(subContainers[0]).width() !== 0
      ) {
    ...
    SearchPane.prototype.rebuildPane = function (last, dataIn, init, maintainSelection) {
      ...
      this.s.displayed = false
      this._buildPane(
        !this.s.dt.page.info().serverSide ? selectedRows : this.s.serverSelect,
        last,
        dataIn,
        init,
        prevEl
    ...
    SearchPane.prototype._setListeners = function () {
      ...
      this.dom.searchBox.on('input.dtsp', function () {
        ...
        if (
          ...
          (searchval.length > 0 ||
            (searchval.length === 0 &&
              _this.s.dtPane.rows({ selected: true }).data().toArray().length > 0))
        ) {
          _this.dom.clear.removeClass(_this.classes.disabledButton).removeAttr('disabled')
        } else {
          _this.dom.clear.addClass(_this.classes.disabledButton).attr('disabled', 'true')
    ...
    SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
      ...
      if (this.colExists) {
        ...
        if (
          (colOpts.show === false || (colOpts.show !== undefined && colOpts.show !== true)) &&
          idx === -1
        ) {
        ...
        if (
          ...
          (dataIn === null || dataIn.searchPanes === null || dataIn.searchPanes.options === null)
        ) {
          ...
          if (dataIn.searchPanes.options[colTitle] !== undefined) {
            for (var _i = 0, _a = dataIn.searchPanes.options[colTitle]; _i < _a.length; _i++) {
              ...
              this.s.rowData.bins[dataPoint.value] =
                this.c.viewTotal || this.c.cascadePanes ? dataPoint.count : dataPoint.total
      ...
      this.s.dtPane = this.dom.dtP.DataTable(
        $.extend(
            ...
            columnDefs: [
              {
                ...
                //  would take place
                type:
                  table.settings()[0].aoColumns[this.s.index] !== undefined
          ...
          this.c.dtOpts,
          colOpts !== undefined ? colOpts.dtOpts : {},
      ...
      for (var _f = 0, selectedRows_1 = selectedRows; _f < selectedRows_1.length; _f++) {
        ...
        if (selection !== undefined) {
          for (var _g = 0, _h = this.s.dtPane.rows().indexes().toArray(); _g < _h.length; _g++) {
            var row = _h[_g]
            if (
              this.s.dtPane.row(row).data() !== undefined &&
      ...
      if (
        ...
        ((this.c.collapse && this.s.colOpts.collapse !== false) || this.s.colOpts.collapse)
      ) {
        this.collapse()
      }
    ...
    SearchPane.prototype._populatePane = function (last) {
      ...
      if (!this.s.dt.page.info().serverSide) {
        var indexArray =
          (this.c.cascadePanes || this.c.viewTotal) && !this.s.clearing && !last
    ...
    SearchPane.prototype._populatePaneArray = function (rowIdx, arrayFilter, settings, bins) {
      ...
      if (typeof colOpts.orthogonal === 'string') {
        var rendered = settings.oApi._fnGetCellData(
          settings,
          rowIdx,
          this.s.index,
          colOpts.orthogonal
        ...
        var filter = settings.oApi._fnGetCellData(
          settings,
          rowIdx,
          this.s.index,
          colOpts.orthogonal.search
        )
        ...
        if (!bins[filter]) {
          ...
          this._addOption(
            filter,
            settings.oApi._fnGetCellData(
              settings,
              rowIdx,
              this.s.index,
              colOpts.orthogonal.display
            ),
      ...
      if (
        ...
        for (var _c = 0, selected_1 = selected; _c < selected_1.length; _c++) {
          ...
          var row = this.addRow(
            ...
            selectedEl.filter,
            0,
            this.c.viewTotal ? selectedEl.total : 0,
            selectedEl.display,
            selectedEl.display
          )
          this.s.updating = true
  ...
  var SearchPanes = /** @class */ (function () {
    function SearchPanes(paneSettings, opts, fromInit) {
      ...
      this.dom = {
        ...
        collapseAll: $$1('<button type="button">Collapse All</button>').addClass(
          this.classes.collapseAll
        ),
        container: $$1('<div/>')
          .addClass(this.classes.panes)
          .text(table.i18n('searchPanes.loadMessage', this.c.i18n.loadMessage)),
      ...
      this.dom.collapseAll.text(
        table.i18n('searchPanes.collapseMessage', this.c.i18n.collapseMessage)
      )
    ...
    SearchPanes.prototype.redrawPanes = function (rebuild) {
      ...
      if (!this.s.updating && !this.s.dt.page.info().serverSide) {
        ...
        if (
          selectTotal === 0 &&
          table.rows({ search: 'applied' }).data().toArray().length ===
            table.rows().data().toArray().length
        ) {
          filterActive = false
        }
        ...
        if (!this.regenerating) {
          ...
          for (var i = 0; i < this.s.selectionList.length; i++) {
            if (
              this.s.selectionList[i].index !== deselectIdx ||
              this.s.selectionList[i].protect === true
            ) {
              var further = false
          ...
          if (
            newSelectionList.length > 0 &&
            (newSelectionList.length < this.s.selectionList.length || rebuild)
          ) {
    ...
    SearchPanes.prototype.resizePanes = function () {
      if (this.c.layout === 'auto') {
        ...
        var widerIndexes =
          highestmod !== 0 ? dispIndex.slice(dispIndex.length - highestmod, dispIndex.length) : []
        for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
          var pane = _c[_b]
    ...
    SearchPanes.prototype._cascadeRegen = function (newSelectionList, selectTotal) {
      ...
      for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
        ...
        if (
          (pane.s.dtPane !== undefined && pane.s.index === solePane) ||
    ...
    SearchPanes.prototype._getState = function () {
      ...
      if (
        loadedFilter &&
        loadedFilter.searchPanes &&
        loadedFilter.searchPanes.selectionList !== undefined
      ) {
    ...
    SearchPanes.prototype._paneDeclare = function (table, paneSettings, opts) {
      ...
      table
        ...
        .each(function (idx) {
          _this.s.panes.push(
            new SearchPane(paneSettings, opts, idx, _this.c.layout, _this.dom.panes)
          )
        })
      ...
      for (var i = 0; i < paneLength; i++) {
        var id = rowLength + i
        this.s.panes.push(
          new SearchPane(paneSettings, opts, id, this.c.layout, this.dom.panes, this.c.panes[i])
        )
      }
    ...
    SearchPanes.prototype._startup = function (table) {
      ...
      for (var _d = 0, _e = this.s.panes; _d < _e.length; _d++) {
        ...
        pane.rebuildPane(
          undefined,
          Object.keys(this.s.serverData).length > 0 ? this.s.serverData : undefined
        )
        this.dom.panes.append(pane.dom.container)
      }
      ...
      $$1(window).on(
        'resize.dtsp',
        dataTable$1.util.throttle(function () {
          _this.resizePanes()
        })
      )
        ...
        if (!_this.s.dt.page.info().serverSide) {
          _this.s.dt.one('preDraw', function () {
            ...
            for (var _i = 0, _a = _this.s.panes; _i < _a.length; _i++) {
              ...
              // when rebuilding
              pane.rebuildPane(
                _this.s.selectionList[_this.s.selectionList.length - 1] !== undefined
  ...
  ;(function (factory) {
    ...
    $.fn.dataTable.ext.buttons.searchPanes = {
      ...
      init: function (dt, node, config) {
        var panes = new $.fn.dataTable.SearchPanes(
          dt,
          $.extend(
            {
