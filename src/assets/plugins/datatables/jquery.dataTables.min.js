...
;(function (l) {
  ...
  function Fb(a) {
    ...
    for (b = g.length; k < b; k++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== m.bSortable &&
          (n.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), fb(a, m.nTh, k)))
  ...
  function ja(a, b) {
    ...
    d !== q &&
      -1 !== d &&
      ((a._iDisplayStart = c ? d : d >= a.fnRecordsDisplay() ? 0 : d), (a.iInitDisplayStart = -1))
      ...
      if (0 !== k.length)
        ...
        (e = f.sZeroRecords),
          ...
          (c[0] = l('<tr/>', { class: h ? d[0] : '' }).append(
            l('<td />', { valign: 'top', colSpan: oa(a), class: a.oClasses.sRowEmpty }).html(e)
          )[0])
  ...
  function Kb(a) {
    ...
    b = l('<div/>', { id: h.f ? null : c + '_filter', class: b.sFilter }).append(
      l('<label/>').append(g)
    )
    var k = function (n) {
      ...
      for (v = 0; v < k.length; v++)
        (w = c[k[v]]),
          ...
          w.sWidthOrig &&
            h &&
            l(m[v]).append(
              l('<div/>').css({ width: w.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 })
            )
      if (a.aoData.length)
        for (v = 0; v < k.length; v++)
      ...
      if (-1 !== l.inArray(!1, f)) a._bLoadingState = !1
        ...
        if (b.columns) {
          ...
          for (d = b.columns.length; f < d; f++) {
            var g = b.columns[f]
            g.visible !== q &&
              (h ? h.column(f).visible(g.visible, !1) : (e[f].bVisible = g.visible))
    ...
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) B.register(a[c], b)
      ...
      for (c = d.length; a < c; a++) {
        ...
        a === c - 1
          ? ((g.val = b),
            (g.type =
              'function' === typeof b ? 'function' : l.isPlainObject(b) ? 'object' : 'other'))
  ...
  y('draw()', function (a) {
    return this.iterator('table', function (b) {
      'page' === a
        ? ja(b)
        : ('string' === typeof a && (a = 'full-hold' === a ? !1 : !0), ka(b, !1 === a))
    })
  })
  y('page()', function (a) {
    return a === q
        ...
        if (null === w || w === q || r) {
          ...
          for (p = e.length; n < p; n++)
            for (g = e[n], t = 0; t < k; t++)
              (v = { row: g, column: t }),
                r
                  ? ((x = d[g]), w(v, T(a, g, t), x.anCells ? x.anCells[t] : null) && m.push(v))
                  : m.push(v)
          return m
        }
        ...
        l(a.nTable).on('order.dt.DT', function (e, h, f, g) {
          a === h &&
            ...
            b
              ...
              .addClass(
                'asc' == g[e] ? d.sSortAsc : 'desc' == g[e] ? d.sSortDesc : c.sSortingClass
              ))
        })
      },
        ...
        l(a.nTable).on('order.dt.DT', function (e, h, f, g) {
          a === h &&
            ...
            b
              ...
              .addClass(
                'asc' == g[e] ? d.sSortJUIAsc : 'desc' == g[e] ? d.sSortJUIDesc : c.sSortingClassJUI
              ))
        })
      }
    }
