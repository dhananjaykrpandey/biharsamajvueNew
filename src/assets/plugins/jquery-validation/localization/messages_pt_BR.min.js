...
!(function (a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      step: a.validator.format('Por favor, forne&ccedil;a um valor m&uacute;ltiplo de {0}.'),
      maxWords: a.validator.format('Por favor, forne&ccedil;a com {0} palavras ou menos.'),
      minWords: a.validator.format('Por favor, forne&ccedil;a pelo menos {0} palavras.'),
      rangeWords: a.validator.format('Por favor, forne&ccedil;a entre {0} e {1} palavras.'),
      ...
      strippedminlength: a.validator.format('Por favor, forne&ccedil;a pelo menos {0} caracteres.'),
