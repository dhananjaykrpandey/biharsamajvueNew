...
!(function (a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      rangelength: a.validator.format('{0} থেকে {1} টি অক্ষর সম্বলিত মান লিখুন।'),
      range: a.validator.format('{0} থেকে {1} এর মধ্যে একটি মান ব্যবহার করুন।'),
      max: a.validator.format('অনুগ্রহ করে {0} বা তার চাইতে কম মান ব্যবহার করুন।'),
      min: a.validator.format('অনুগ্রহ করে {0} বা তার চাইতে বেশি মান ব্যবহার করুন।')
    }),
    a
  )
})
