...
!(function (a) {
  ...
  return (
    ...
    a.validator.addMethod(
      ...
      function (a, b) {
        ...
        if (
          ...
          return !1
        for (
          var c = a.length - 2, d = a.substring(0, c), e = a.substring(c), f = 0, g = c - 7, h = c;
          h >= 1;
          h--
        )
    ...
    a.validator.addMethod(
      ...
      function (b, c, d) {
        return (
          !!this.optional(c) || !('file' === a(c).attr('type') && c.files && c.files.length > d)
        )
      },
    ...
    a.validator.addMethod(
      ...
      function (b, c, d) {
        ...
        if ('file' === a(c).attr('type') && c.files && c.files.length)
          for (var e = 0; e < c.files.length; e++) if (c.files[e].size > d) return !1
        return !0
      },
    ...
    a.validator.addMethod(
      ...
      function (a) {
        ...
        if (((a = a.replace(/([~!@#$%^&*()_+=`{}\[\]\-|\\:;'<>,.\/? ])+/g, '')), 11 !== a.length))
          return !1
        for (
          c = parseInt(a.substring(10, 11), 10), b = parseInt(a.substring(0, 10), 10), e = 2;
          e < 12;
          e++
        )
          (f = e),
