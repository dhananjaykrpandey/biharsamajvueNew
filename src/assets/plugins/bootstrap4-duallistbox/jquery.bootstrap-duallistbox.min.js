...
!(function (n) {
  ...
  function o(s) {
    s.element.find('option').each(function (e, t) {
      var n = a(t)
      void 0 === n.data('original-index') && n.data('original-index', s.elementCount++),
  ...
  function r(s, i, l) {
    s.element.find('option').each(function (e, t) {
      ...
      n.data('original-index') === i &&
        (n.prop('selected', l),
        l ? (n.attr('data-sortindex', s.sortIndex), s.sortIndex++) : n.removeAttr('data-sortindex'))
    })
  }
  function c(e, n) {
    return (
    ...
    if (e.settings.infoText) {
      ...
      ;(l =
        0 == s
          ...
          : c(t === s ? e.settings.infoText : e.settings.infoTextFiltered, [t, s])),
        e.elements.info1.html(l),
        e.elements.box1.toggleClass('filtered', !(t === s || 0 == s)),
        (l =
          0 === i
            ? e.settings.infoTextEmpty
            : c(n === i ? e.settings.infoText : e.settings.infoTextFiltered, [n, i])),
  ...
  function m(s) {
    ;(s.selectedElements = 0),
      ...
      s.element.find('option').each(function (e, t) {
        ...
        n.prop('selected')
          ? (s.selectedElements++,
            s.elements.select2.append(n.clone(!0).prop('selected', n.data('_selected'))))
          : s.elements.select1.append(n.clone(!0).prop('selected', n.data('_selected')))
      }),
  ...
  function e(i, l) {
    if (i.settings.showFilterInputs) {
      ...
      e.each(function (e, t) {
        var n = a(t),
          s = !0
        ;(t.text.match(o) || (i.settings.filterOnValues && n.attr('value').match(o))) &&
          ((s = !1),
          i.elements['select' + l].append(n.clone(!0).prop('selected', n.data('_selected')))),
  ...
  function f(s) {
    'all' !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect
      ? 'moved' !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect || d(s, 1)
      : (d(s, 1), d(s, 2)),
      ...
      m(s),
      t(s),
      s.settings.sortByInputOrder ? u(s.elements.select2) : v(s.elements.select2, s)
  }
  function p(s) {
    'all' !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect
      ? 'moved' !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect || d(s, 2)
      : (d(s, 1), d(s, 2)),
    ...
    n.elements.form.submit(function (e) {
      ...
      !1 === n.settings.eventMoveAllOverride &&
        n.elements.moveAllButton.on('click', function () {
          var s
          'all' !== (s = n).settings.preserveSelectionOnMove || s.settings.moveOnSelect
            ? 'moved' !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect || d(s, 1)
            : (d(s, 1), d(s, 2)),
            s.element.find('option').each(function (e, t) {
              var n = a(t)
              n.data('filtered1') ||
                (n.prop('selected', !0), n.attr('data-sortindex', s.sortIndex), s.sortIndex++)
            }),
            m(s),
            t(s)
        }),
      ...
      !1 === n.settings.eventRemoveAllOverride &&
        n.elements.removeAllButton.on('click', function () {
          var e
          'all' !== (e = n).settings.preserveSelectionOnMove || e.settings.moveOnSelect
            ? 'moved' !== e.settings.preserveSelectionOnMove || e.settings.moveOnSelect || d(e, 2)
            : (d(e, 1), d(e, 2)),
  ...
  ;(l.prototype = {
    ...
    setHelperSelectNamePostfix: function (e, t) {
      return (
        (this.settings.helperSelectNamePostfix = e)
          ? (this.elements.select1.attr('name', this.originalSelectName + e + '1'),
            this.elements.select2.attr('name', this.originalSelectName + e + '2'))
          : (this.elements.select1.removeAttr('name'), this.elements.select2.removeAttr('name')),
        t && m(this),
        this.element
      )
    },
    ...
    setShowFilterInputs: function (e, t) {
      return (
        e
          ? (this.elements.filterInput1.show(), this.elements.filterInput2.show())
    ...
    setBtnClass: function (e, t) {
      return (
        ...
        this.elements.removeAllButton.attr('class', 'btn removeall').addClass(e),
        t && m(this),
        this.element
      )
    },
    ...
    (a.fn[i] = function (n) {
      ...
      return void 0 === n || 'object' == typeof n
        ? this.each(function () {
            a(this).is('select')
              ? a.data(this, 'plugin_' + i) || a.data(this, 'plugin_' + i, new l(this, n))
              : a(this)
                  .find('select')
                  .each(function (e, t) {
