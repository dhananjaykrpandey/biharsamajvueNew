...
;(function (h) {
    ...
    b.on('mousedown.dtSelect', d, function (g) {
      ...
      .on('click.dtSelect', d, function (g) {
        ...
        if (e) {
          ...
          if (
            (!k.anchorNode || h(k.anchorNode).closest('table')[0] === a.table().node()) &&
            k !== e
          )
            return
        }
        ...
        if (
          h(g.target).closest('div.' + n)[0] == a.table().container() &&
          ...
          q.isDefaultPrevented() ||
            ...
            'row' === f
              ...
              : 'cell' === f && ((f = n.index()), E(g, a, k, 'cell', f)),
  ...
  function u(a, b, c, d) {
    if (!d || a.flatten().length)
      'string' === typeof b && (b += '.dt'), c.unshift(a), h(a.table().node()).trigger(b, c)
  }
  function N(a) {
    var b = a.settings()[0]
        ...
        g = function (f, k, n) {
          f.append(
            h('<span class="select-item"/>').append(
              a.i18n(
                'select.' + k + 's',
                { _: '%d ' + k + 's selected', 0: '', 1: '1 ' + k + ' selected' },
                n
              )
            )
          )
    ...
    a.aoRowCreatedCallback.push({
      fn: function (c, d, e) {
        ...
        for (e = a.aoColumns.length; c < e; c++)
          (a.aoColumns[c]._select_selected || (d._selected_cells && d._selected_cells[c])) &&
      ...
      'os' === g
        ? a.ctrlKey || a.metaKey
          ...
          ? 'cell' === d
            ...
            : K(b, d, e, c._select_lastCell ? c._select_lastCell[d] : null)
          : ((a = b[d + 's']({ selected: !0 })),
            k && 1 === a.flatten().length ? b[d](e).deselect() : (a.deselect(), b[d](e).select()))
        : 'multi+shift' == g
        ? a.shiftKey
          ? 'cell' === d
            ? I(b, e, c._select_lastCell || null)
    ...
    if (!b._select) {
      ...
      a.one('init', function () {
        a.on('stateSaveParams', function (t, G, p) {
          ...
          p.select.cells = a.cells({ selected: !0 })[0].map(function (L) {
            return { row: a.row(L.row).id(!0), column: L.column }
          })
        })
        d(l, l, c)
    ...
    function (a, b) {
      m.ext.selector[b.type].push(function (c, d, e) {
        ...
        for (var f = 0, k = e.length; f < k; f++) {
          var n = c[b.prop][e[f]]
          ;((!0 === d && !0 === n._select_selected) || (!1 === d && !n._select_selected)) &&
            g.push(e[f])
        }
        return g
      })
