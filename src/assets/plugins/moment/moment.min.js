!(function (e, t) {
  ...
  ;(pn.add = Jt),
    ...
    (pn.inspect = function () {
      ...
      return (
        this.isLocal() ||
          ((s = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (i = 'Z')),
        (e = '[' + s + '("]'),
    ...
    (pn.local = function (e) {
      return (
        this._isUTC &&
          (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(Et(this), 'm')),
        this
      )
    }),
      ...
      return (
        null != this._tzm
          ...
          : 'string' == typeof this._i &&
            (null != (e = Vt(le, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)),
        this
      )
    }),
  ...
  ;(kn.calendar = function (e, t, n) {
    ...
    (kn.erasNarrowRegex = function (e) {
      return (
        m(this, '_erasNarrowRegex') || hn.call(this), e ? this._erasNarrowRegex : this._erasRegex
      )
    }),
    ...
    lt('en', {
      ...
      ordinal: function (e) {
        ...
        return (
          e +
          (1 === Z((e % 100) / 10) ? 'th' : 1 == t ? 'st' : 2 == t ? 'nd' : 3 == t ? 'rd' : 'th')
        )
      }
    }),
  ...
  function Jn(e, t, n, s) {
    ...
    return (
      ...
      ((c = c || (l <= 1 && ['M']) || (l < n.M && ['MM', l]) || (d <= 1 && ['y']) || ['yy', d])[2] =
        t),
      (c[3] = 0 < +e),
      (c[4] = s),
      function (e, t, n, s, i) {
  ...
  return (
    ...
    (es.humanize = function (e, t) {
      ...
      return (
        ...
        'object' == typeof t &&
          ((r = Object.assign({}, Bn, t)), null != t.s && null == t.ss && (r.ss = t.s - 1)),
        (n = this.localeData()),
        (s = Jn(this, !i, r, n)),
    ...
    (f.relativeTimeThreshold = function (e, t) {
      return (
        void 0 !== Bn[e] && (void 0 === t ? Bn[e] : ((Bn[e] = t), 's' === e && (Bn.ss = t - 1), !0))
      )
    }),
