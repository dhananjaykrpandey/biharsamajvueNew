        ...
        usa_states: {
          ...
          latLngToGrid: function (a, b, c, d, e, f) {
            var g,
              ...
              o = (c + d) / 2
            return (
              (g = (Math.sin((c / 180) * n) + Math.sin((d / 180) * n)) / 2),
              (h = Math.sqrt(Math.cos((c / 180) * n)) + 2 * g * Math.sin((c / 180) * n)),
              (i = (f * Math.pow(h - 2 * g * Math.sin((o / 180) * n), 0.5)) / g),
              (j = g * (b - e)),
              (m = (f * Math.pow(h - 2 * g * Math.sin((a / 180) * n), 0.5)) / g),
            ...
            return (
              a > 51
                ...
                : ((c = -17),
                  ...
                  (k[0] =
                    50 +
                    (1.9694462586094064 - (a * Math.PI) / 180) *
                      Math.sin((0.6010514667026994 * (b + 96) * Math.PI) / 180) *
                      124.03149777329222),
                  (k[1] =
                    55.23670416287796 -
                    200.38467697709729 *
                      (1.3236744353715044 -
                        (1.9694462586094064 - (a * Math.PI) / 180) *
                          Math.cos((0.6010514667026994 * (b + 96) * Math.PI) / 180)))),
              { x: k[0] * e + c, y: k[1] * f + d }
            )
          },
          elems: {
