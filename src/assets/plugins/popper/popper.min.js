...
function c(e) {
  ...
  return n && 'BODY' !== n && 'HTML' !== n
    ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(o.nodeName) && 'static' === d(o, 'position')
      ? c(o)
      : o
    : e
...
function P(e, t, o, n, i = !1) {
  ...
  if ('viewport' === n) r = D(p, i)
    ...
    let o
    'scrollParent' === n
      ? ((o = f(s(t))), 'BODY' === o.nodeName && (o = e.ownerDocument.documentElement))
      : 'window' === n
...
function z(e, t, o, n) {
  ...
  const i = f(e)
  return (
    q(i, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = i), (o.eventsEnabled = !0), o
  )
}
function G() {
...
function X() {
  this.state.eventsEnabled &&
    (cancelAnimationFrame(this.scheduleUpdate), (this.state = _(this.reference, this.state)))
}
function J(e) {
...
function ee(e, t, o, n, i) {
  ...
  return (
    t.setAttribute('x-placement', p), Q(t, { position: o.positionFixed ? 'fixed' : 'absolute' }), o
  )
}
function te(e, t) {
...
function ce(e, t, o, n) {
  ...
  let f =
    -1 === d
      ? [p]
      : [p.slice(0, d).concat([p[d].split(s)[0]]), [p[d].split(s)[1]].concat(p.slice(d + 1))]
  return (
    (f = f.map((e, n) => {
