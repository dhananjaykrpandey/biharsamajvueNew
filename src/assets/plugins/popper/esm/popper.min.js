...
function N(e, t) {
  ...
  var g = C({ top: p.top - d.top - m, left: p.left - d.left - c, width: p.width, height: p.height })
...
function B(e, t, o, n) {
  ...
  if ('viewport' === n) r = P(p, i)
    ...
    var s
    'scrollParent' === n
      ? ((s = a(d(t))), 'BODY' === s.nodeName && (s = e.ownerDocument.documentElement))
      : 'window' === n
...
function _(e, t, o, n) {
  ...
  r.addEventListener(t, o, { passive: !0 }), i || _(a(r.parentNode), t, o, n), n.push(r)
}
function X(e, t, o, n) {
  ;(o.updateBound = n), G(e).addEventListener('resize', o.updateBound, { passive: !0 })
  var i = a(e)
  return (
    _(i, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = i), (o.eventsEnabled = !0), o
  )
}
function J() {
...
function Z() {
  this.state.eventsEnabled &&
    (cancelAnimationFrame(this.scheduleUpdate), (this.state = Q(this.reference, this.state)))
}
function $(e) {
...
function oe(e) {
  return (
    ...
    e.arrowElement && Object.keys(e.arrowStyles).length && ee(e.arrowElement, e.arrowStyles),
    e
  )
}
function ne(e, t, o, n, i) {
  ...
  return (
    t.setAttribute('x-placement', p), ee(t, { position: o.positionFixed ? 'fixed' : 'absolute' }), o
  )
}
function ie(e, t) {
  var o = e.offsets,
...
var Oe = {
    ...
    computeStyle: { order: 850, enabled: !0, fn: pe, gpuAcceleration: !0, x: 'bottom', y: 'right' },
    applyStyle: { order: 900, enabled: !0, fn: oe, onLoad: ne, gpuAcceleration: void 0 }
  },
  Le = {
    placement: 'bottom',
    positionFixed: !1,
