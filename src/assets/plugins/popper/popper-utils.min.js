...
function u(b, d, e = !1) {
  ...
  let q = s({ top: j.top - k.top - o, left: j.left - k.left - p, width: j.width, height: j.height })
...
function y(a, e, f, g, h = !1) {
  ...
  if ('viewport' === g) i = v(j, h)
    ...
    let d
    'scrollParent' === g
      ? ((d = c(b(e))), 'BODY' === d.nodeName && (d = a.ownerDocument.documentElement))
      : 'window' === g
...
const B = (function () {
  ...
  for (let b = 0; b < a.length; b += 1) if (e && 0 <= navigator.userAgent.indexOf(a[b])) return 1
  return 0
})()
function C(a) {
  let b = !1
...
function Y(a, b, d, e) {
  ...
  const f = c(a)
  return (
    X(f, 'scroll', d.updateBound, d.scrollParents), (d.scrollElement = f), (d.eventsEnabled = !0), d
  )
}
var Z = {
