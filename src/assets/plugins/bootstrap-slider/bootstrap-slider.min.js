      ...
      function e(b, c) {
        ...
        if (
          ...
          'none' === this.options.selection
            ...
            : ('after' === this.options.selection || 'before' === this.options.selection) &&
        ...
        if (
          ...
          if (
            ...
            ;(this.handleCallbackMap.handle1 = { mouseEnter: O, mouseLeave: P }),
              ...
              (this.handleCallbackMap.handle2 = { mouseEnter: O, mouseLeave: P })
          } else
            this.sliderElem.addEventListener('mouseenter', this.showTooltip, !1),
              ...
              this.touchCapable &&
                (this.sliderElem.addEventListener('touchstart', this.showTooltip, !1),
                this.sliderElem.addEventListener('touchmove', this.showTooltip, !1),
                this.sliderElem.addEventListener('touchend', this.hideTooltip, !1))
          ...
          logarithmic: {
            toValue: function (a) {
              ...
              return Math.round(e) === d
                ...
                : ((e =
                    this.options.min +
                    Math.round((e - this.options.min) / this.options.step) * this.options.step),
        ...
        (d.prototype = {
          ...
          setValue: function (a, b, c) {
            ...
            this.options.range
              ...
              : ((this._state.value = e(this._state.value)),
                this.ticksAreValid &&
                  this.options.lock_to_ticks &&
                  (this._state.value =
                    this.options.ticks[this._getClosestTickIndex(this._state.value)]),
                (this._state.value = [
            ...
            return (
              ...
              g && c === !0 && this._trigger('change', { oldValue: d, newValue: f }),
              this
            )
          },
          destroy: function () {
          ...
          refresh: function (d) {
            ...
            return (
              ...
              a &&
                (f === b
                  ? (a.data(this.element, b, this), a.data(this.element, c, this))
          ...
          _removeSliderEventHandlers: function () {
            if (
              ...
              for (
                var a = this.ticksContainer.getElementsByClassName('slider-tick'), b = 0;
                b < a.length;
                b++
              )
            ...
            ;(this.handleCallbackMap = null),
              ...
              this.touchCapable &&
                ...
                this.hideTooltip &&
                  (this.handle1.removeEventListener('touchend', this.hideTooltip, !1),
                  this.handle2.removeEventListener('touchend', this.hideTooltip, !1)),
                this.showTooltip &&
                  (this.sliderElem.removeEventListener('touchstart', this.showTooltip, !1),
                  this.sliderElem.removeEventListener('touchmove', this.showTooltip, !1)),
                this.hideTooltip &&
                  this.sliderElem.removeEventListener('touchend', this.hideTooltip, !1),
          ...
          _setToolTipOnMouseOver: function (a) {
            function b(a, b) {
              return b
                ? [100 - a.percentage[0], c.options.range ? 100 - a.percentage[1] : a.percentage[1]]
              ...
              addMouseEnter: function (a, b, c) {
                var d = function () {
                  ...
                  void 0 !== c
                    ? ((e = a.options.ticks[c]),
                      (f =
                        (a.options.ticks_positions.length > 0 && a.options.ticks_positions[c]) ||
          ...
          _layout: function () {
            ...
            if (
              ...
              for (var c = 0; c < this.options.rangeHighlights.length; c++) {
                ...
                g
                  ? 'vertical' === this.options.orientation
                    ? ((this.rangeHighlightElements[c].style.top = g.start + '%'),
                      (this.rangeHighlightElements[c].style.height = g.size + '%'))
                    : (this.options.rtl
                        ? (this.rangeHighlightElements[c].style.right = g.start + '%')
                        : (this.rangeHighlightElements[c].style.left = g.start + '%'),
                      (this.rangeHighlightElements[c].style.width = g.size + '%'))
            ...
            if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
              ...
              if (this.tickLabelContainer) {
                ...
                if (0 === this.options.ticks_positions.length)
                  ...
                  for (l = 0; l < this.tickLabelContainer.childNodes.length; l++)
              ...
              for (var l = 0; l < this.options.ticks.length; l++) {
                ...
                this.options.reversed && (m = 100 - m),
                  ...
                  this.options.range
                    ? m >= a[0] && m <= a[1] && this._addClass(this.ticks[l], 'in-selection')
                  ...
                  this.tickLabels[l] &&
                    ...
                    this._removeClass(this.tickLabels[l], 'label-in-selection label-is-selection'),
                    this.options.range
                      ? m >= a[0] &&
                        m <= a[1] &&
                        (this._addClass(this.tickLabels[l], 'label-in-selection'),
                        (m === a[0] || a[1]) &&
                          this._addClass(this.tickLabels[l], 'label-is-selection'))
                      : ('after' === this.options.selection && m >= a[0]
                          ? this._addClass(this.tickLabels[l], 'label-in-selection')
                          : 'before' === this.options.selection &&
                            m <= a[0] &&
                            this._addClass(this.tickLabels[l], 'label-in-selection'),
                        m === a[0] && this._addClass(this.tickLabels[l], 'label-is-selection')))
              }
            }
            var n
          ...
          _adjustPercentageForRangeSliders: function (a) {
            if (this.options.range) {
              ...
              this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
                ...
                : 0 === this._state.keyCtrl && this._toPercentage(this._state.value[1]) < a
                ? ((this._state.percentage[0] = this._state.percentage[1]),
