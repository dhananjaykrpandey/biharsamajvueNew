...
var FullCalendar = (function (exports) {
  ...
  function g$1(n, l, u) {
    ...
    for (i = 0; i < n.__k.length; i++)
      (t = n.__k[i]) &&
        ((t.__ = n),
        (l = 'function' == typeof t.type ? g$1(t, l, u) : x$1(u, t, t, n.__k, t.__e, l)))
    return l
  }
  function w$1(n, l) {
    return (
  ...
  function I$1(l, u, i, t, o, r, f, e, s) {
    ...
    null != i.__h && ((s = i.__h), (e = u.__e = i.__e), (u.__h = null), (r = [e])),
      (a = n.__b) && a(u)
    try {
      ...
      ;(u.__v = null),
        (s || null != r) && ((u.__e = e), (u.__h = !!s), (r[r.indexOf(e)] = null)),
        n.__e(l, u, i)
    }
  }
  function T$1(l, u) {
  ...
  ;(n = {
    ...
    (p.prototype.setState = function (n, l) {
      var u
      ;(u =
        null != this.__s && this.__s !== this.state ? this.__s : (this.__s = c$1({}, this.state))),
  ...
  function getEventTargetViaRoot(ev) {
    var _a, _b
    return (_b = (_a = ev.composedPath) === null || _a === void 0 ? void 0 : _a.call(ev)[0]) !==
      null && _b !== void 0
      ? _b
      : ev.target
  }
  ...
  function asRoughMs(dur) {
    return (
      dur.years * (365 * 864e5) + dur.months * (30 * 864e5) + dur.days * 864e5 + dur.milliseconds
    )
  }
  // Advanced Math
    ...
    return function (newArgHash) {
      ...
      for (var key in newArgHash) {
        if (!currentResHash[key]) {
          ...
          newResHash[key] =
            resEquality && resEquality(res, currentResHash[key]) ? currentResHash[key] : res
        } else {
  ...
  function parseSingle(refined, defaultAllDay, context, allowOpenRange) {
    ...
    if (allDay == null) {
      if (defaultAllDay != null) {
        ...
        allDay =
          (!startMeta || startMeta.isTimeUnspecified) && (!endMeta || endMeta.isTimeUnspecified)
      }
    }
  ...
  function buildSegTimeText(
    ...
    var isEndDay =
      startOfDay(addMs(wholeEventEnd, -1)).valueOf() === startOfDay(addMs(segEnd, -1)).valueOf()
  ...
  function buildDateEnv$1(settings) {
    ...
    return new DateEnv(
      __assign(
        __assign({ timeZone: BASE_OPTION_DEFAULTS.timeZone, calendarSystem: 'gregory' }, settings),
        { locale: locale }
      )
    )
  }
  ...
  var Emitter = /** @class */ (function () {
    ...
    Emitter.prototype.hasHandlers = function (type) {
      return Boolean(
        (this.handlers[type] && this.handlers[type].length) || (this.options && this.options[type])
      )
    }
    return Emitter
  })()
  ...
  var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.buildValidRange = function () {
      ...
      var simpleInput =
        typeof input === 'function' ? input.call(this.props.calendarApi, this.nowDate) : input
  ...
  function warnUnknownOptions(options, viewName) {
    for (var optionName in options) {
      console.warn(
        "Unknown option '" + optionName + "'" + (viewName ? " for view '" + viewName + "'" : '')
      )
    }
  }
  ...
  var CalendarContent = /** @class */ (function (_super) {
    ...
    CalendarContent.prototype.render = function () {
      ...
      var viewLabelId =
        toolbarConfig.header && toolbarConfig.header.hasTitle ? this.state.viewLabelId : ''
      return createElement(
    ...
    CalendarContent.prototype.componentDidMount = function () {
      var props = this.props
      this.calendarInteractions = props.pluginHooks.calendarInteractions.map(function (
  ...
  var TableDateCell = /** @class */ (function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      ...
      var navLinkAttrs =
        !dayMeta.isDisabled && props.colCnt > 1 ? buildNavLinkAttrs(this.context, date) : {}
      var hookProps = __assign(
        __assign(__assign({ date: dateEnv.toDate(date), view: viewApi }, props.extraHookProps), {
          text: text
        }),
        dayMeta
      )
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    function SimpleScrollGrid() {
      ...
      _this.handleSizing = function () {
        _this.setState(
          __assign({ shrinkWidth: _this.computeShrinkWidth() }, _this.computeScrollerDims())
        )
      }
      return _this
    }
        ...
        if (_this.isDragging) {
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              for (
                var _i = 0,
                  _b = initialContext_1.getCurrentData().pluginHooks.eventDropTransformers;
                _i < _b.length;
                _i++
              ) {
      ...
      this.handleDragEnd = function (pev) {
        ...
        if (receivingContext && droppableEvent) {
          ...
          receivingContext.emitter.trigger(
            'drop',
            __assign(
              __assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext)),
          ...
          return createElement(
            ...
            __assign(
              ...
              _this.slicer.sliceProps(props, dateProfile, null, context, dayRanges),
              {
                ...
                nowDate: nowDate,
                nowIndicatorSegs:
                  isNowIndicator && _this.slicer.sliceNowDate(nowDate, context, dayRanges),
                todayRange: todayRange,
