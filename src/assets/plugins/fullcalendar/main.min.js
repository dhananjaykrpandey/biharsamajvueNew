...
var FullCalendar = (function (e) {
  ...
  ;(i = {
    ...
    (y.prototype.setState = function (e, t) {
      var n
      ;(n =
        null != this.__s && this.__s !== this.state ? this.__s : (this.__s = f({}, this.state))),
  ...
  function _e(e) {
    var t, n
    return null !== (n = null === (t = e.composedPath) || void 0 === t ? void 0 : t.call(e)[0]) &&
      void 0 !== n
      ? n
      : e.target
  }
  ...
  function je(e) {
    ...
    for (
      ...
      'string' == typeof (n = o[t])
        ? r.push(
            '-' === n.charAt(0) ? { field: n.substring(1), order: -1 } : { field: n, order: 1 }
          )
  ...
  function Ft(e, t, n) {
    ...
    return (
      ...
      r.length > 10 &&
        (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', jt(t, !0)))),
      r
    )
  }
  function Bt(e) {
  ...
  function Hn(e, t, n, r, o) {
    ...
    var c,
      d = (function (e, t, n, r) {
        ...
        null == a &&
          (a = null != t ? t : (!o || o.isTimeUnspecified) && (!i || i.isTimeUnspecified))
        a && s && (s = lt(s))
  ...
  function jn(e, t) {
    ...
    return (
      null !== t.start &&
        (n = null === n ? t.start : new Date(Math.max(n.valueOf(), t.start.valueOf()))),
  ...
  function yr(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, vr(n.range, o, n.allDay)), { allDay: n.allDay }))), i
    )
  }
  function Er(e, t, n) {
    var r = n.dateEnv,
  ...
  var kr = (function () {
      ...
      return (
        ...
        (e.prototype.gotoDate = function (e) {
          ...
          this.unselect(),
            this.dispatch({ type: 'CHANGE_DATE', dateMarker: t.dateEnv.createMarker(e) })
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: 'ADD_EVENTS', eventStore: Sn(s) }), this.triggerEventAdd(l), l
            )
          }
          return null
        }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Pn)
            ...
            (t = In[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) })
          else if (e in _n) {
            var o = _n[e](t)
            'color' === e
  ...
  var Lr = (function () {
      function e(e) {
        ...
        e.namedTimeZoneImpl && n && (this.namedTimeZoneImpl = new e.namedTimeZoneImpl(t)),
          ...
          (this.weekTextLong =
            (null != e.weekTextLong ? e.weekTextLong : e.locale.options.weekTextLong) ||
            this.weekText),
            ...
            n.formatRange(
              {
                marker: e,
                timeZoneOffset:
                  null != r.forcedStartTzo ? r.forcedStartTzo : this.offsetForMarker(e)
              },
              {
                marker: t,
    ...
    qi = (function () {
      ...
      return (
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          ...
          return (
            ...
            r
              ? (n.push.apply(
                  n,
                  o([{ index: e.index, thickness: e.thickness, span: $i(s, a) }], i)
                ),
                r)
              : (n.push(e), 0)
          )
        ...
        (e.prototype.toRects = function () {
          for (
            var e = this.entriesByLevel, t = this.levelCoords, n = e.length, o = [], i = 0;
            i < n;
            i += 1
          )
  ...
  var la = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            var t = this.props, n = this.context.theme, r = [], i = !0, a = 0, s = e;
            a < s.length;
            a++
          ) {
            var l = s[a],
    ...
    xa = (function () {
      ...
      return (
        ...
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a]
          return e
            ? this._sliceEventStore.apply(this, o([xt(e, Ma(t, Boolean(n)), r), {}, t, n], i)).bg
            : []
        }),
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            o.isRendered && ((o.isRendered = !1), No(o.el), o.setClassNames([]), o.setHeight(''))
          Po()
        }),
        (o.el = t),
      ...
      function t(t) {
        ...
        ;(n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (mr(n.dragSelection, e, n.component.context), (n.dragSelection = null))
          })
  ...
  function tl(e, t) {
    ...
    if (e) {
      for (a = 0; a < t; a += 1)
        n[a] = { affectedInstances: e.affectedInstances, isEvent: e.isEvent, segs: [] }
                ...
                _o(
                  ...
                  n.showWeekNumber &&
                    _o(fs, { date: a, defaultFormat: dl }, function (e, t, n, o) {
                      return _o(
                        'a',
                        r({ ref: e, className: ['fc-daygrid-week-number'].concat(t).join(' ') }, l),
                        o
                      )
                    }),
                  !c &&
  ...
  function fl(e, t, n, r, o, i, a) {
    ...
    for (var l = [], u = [], c = 0; c < e.length; c += 1) {
      ...
      null != d
        ? l.push({ index: c, thickness: d, span: { start: R.firstCol, end: R.lastCol + 1 } })
        : u.push(R)
    }
    for (
      var p = s.addSegs(l),
  ...
  function uu(e) {
    return _o(
      ...
      e.sideText &&
        _o(
          'a',
          r({ 'aria-hidden': !0, className: 'fc-list-day-side-text' }, e.sideNavLinkAttrs),
          e.sideText
        )
    )
  }
