            ...
            class: function () {
              ...
              return (
                ...
                o
                  ...
                  .concat([l.options.baseClass], l._getClasses(l.options.wrapperClass))
                  .join(' ')
              )
            }
          })),
        ...
        f(j, [
            ...
            value: function (l, m) {
              return 'undefined' == typeof l
                ...
                : (this.$element.is(':radio')
                  ...
                  this.$element.prop('checked', !!l).trigger('change.bootstrapSwitch', m),
                  this.$element)
            }
          },
          {
          ...
          },
          {
            ...
            value: function (l) {
              return 'undefined' == typeof l
                ...
                : (this.$label.html(l), this._width(), (this.options.labelText = l), this.$element)
            }
          },
          {
            key: 'handleWidth',
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                l.length && l.off('reset.bootstrapSwitch').removeData('bootstrap-switch'),
              ...
              return this.$element.on({
                ...
                'previousState.bootstrapSwitch': function () {
                  ;(l.options = l.prevOptions),
                    l.options.indeterminate && l.$wrapper.addClass(l._getClass('indeterminate')),
                    l.$element
                ...
                'keydown.bootstrapSwitch': function (n) {
                  !n.which ||
                    ...
                    ((37 === n.which || 39 === n.which) &&
                      (n.preventDefault(), n.stopImmediatePropagation(), l.state(39 === n.which)))
                }
              })
            }
          },
              ...
              this.$label.on({
                ...
                'mousedown.bootstrapSwitch touchstart.bootstrapSwitch': function (o) {
                  l._dragStart ||
                    ...
                    l.options.animate && l.$wrapper.removeClass(l._getClass('animate')),
                    l.$element.trigger('focus.bootstrapSwitch'))
                },
                'mousemove.bootstrapSwitch touchmove.bootstrapSwitch': function (o) {
                  if (null != l._dragStart) {
                    ...
                    o.preventDefault(),
                      p < -l._handleWidth ||
                        0 < p ||
                        ((l._dragEnd = p), l.$container.css('margin-left', l._dragEnd + 'px'))
                  }
                },
                'mouseup.bootstrapSwitch touchend.bootstrapSwitch': function (o) {
                  if (l._dragStart) {
                    if (
                      (o.preventDefault(),
                      l.options.animate && l.$wrapper.addClass(l._getClass('animate')),
                      l._dragEnd)
                    ) {
