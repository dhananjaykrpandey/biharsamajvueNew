!(function (e, t) {
  ...
  const R = () => L('.'.concat(p.loader)),
    ...
    _ = () => O(p.close),
    K = () => {
      const e = i(g().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
        (e, t) => {
        ...
        (function (e, t, n, o) {
          ...
          u([e, t, n], p.styled),
            o.confirmButtonColor &&
              ((e.style.backgroundColor = o.confirmButtonColor), u(e, p['default-outline']))
          o.denyButtonColor &&
            ((t.style.backgroundColor = o.denyButtonColor), u(t, p['default-outline']))
          o.cancelButtonColor &&
            ((n.style.backgroundColor = o.cancelButtonColor), u(n, p['default-outline']))
        })(i, a, r, o),
        o.reverseButtons &&
          (o.toast
  ...
  const Te = (e, t) => {
    ...
    i &&
      ...
      (n = t.position) in p
        ? u(o, p[n])
        : (a('The "position" parameter is not valid, defaulting to "center"'), u(o, p.center)),
      (n = i),
  ...
  const Se = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
    ...
    He =
      ...
      (Ie.range = (e, t) => {
        ...
        return (
          (n.value = t.inputValue), (n.type = t.input), (o.value = t.inputValue), Me(n, e, t), e
        )
      }),
      (Ie.select = (e, t) => {
    ...
    ze = (e, t) => {
      ...
      ;(e.textContent = ''),
        t.iconHtml
          ...
          : 'error' === t.icon
          ? l(e, We)
          : ((n = { question: '?', warning: '!', info: 'i' }), l(e, Ke(n[t.icon])))
    },
    _e = (e, t) => {
      if (t.iconColor) {
    ...
    Xe = (e, t) => {
      ...
      const o = g()
      t.toast
        ? (ae(n, 'width', t.width), (o.style.width = '100%'), o.insertBefore(R(), j()))
        : ae(o, 'width', t.width),
        ...
        h(q())
      n = o
      ;((n.className = ''.concat(p.popup, ' ').concat(ce(n) ? t.showClass.popup : '')), t.toast)
        ? (u([document.documentElement, document.body], p['toast-shown']), u(n, p.toast))
        : u(n, p.modal)
  ...
  const mt = () => {
    ...
    St = (e, t) => {
      ...
      if (!n.input)
        return v(
          'The "input" parameter is needed to be set when using returnInputValueOn'.concat(y(t))
        )
      var o = ((e, t) => {
        const n = e.getInput()
        if (!n) return null
  ...
  const Rt = (e, t, n) => {
    ...
    Wt = (e, n, o) => {
      ...
      if (i)
        if ((i.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key))
          (e = e),
            (a = n),
            (t = i),
            w(t.allowEnterKey) &&
              ...
              (['textarea', 'file'].includes(t.input) || (Nt(), a.preventDefault()))
        else if ('Tab' !== n.key) {
  ...
  const pn = (l, u, d) =>
      new Promise((e, t) => {
        ...
        Gt.swalPromiseResolve.set(l, e),
          ...
          (t = u),
          (a = n),
          b.innerParams.get(e).toast ? Dt(e, t, a) : (Ht(t), qt(t), Vt(e, t, a)),
          (o = l),
          (e = f),
          (t = d),
          (i = n),
    ...
    bn = (e, t) =>
      t.focusDeny && ce(e.denyButton)
        ...
        : !(!t.focusConfirm || !ce(e.confirmButton)) && (e.confirmButton.focus(), !0),
    yn = () => {
