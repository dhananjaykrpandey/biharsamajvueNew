...
$jscomp.polyfill = function (c, h, g, k) {
  h &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(c, h, g, k)
      : $jscomp.polyfillUnisolated(c, h, g, k))
}
...
;(function (c) {
  ...
  var l = c.fn.dataTable,
    ...
    r = function (a, d) {
      ...
      this.dom = {
        ...
        select: {
          top: c('<div class="dt-autofill-select top"/>'),
          right: c('<div class="dt-autofill-select right"/>'),
          bottom: c('<div class="dt-autofill-select bottom"/>'),
          left: c('<div class="dt-autofill-select left"/>')
        },
  ...
  c.extend(r.prototype, {
    ...
    _constructor: function () {
      ...
      b.length &&
        ((this.dom.dtScroll = b), 'static' === b.css('position') && b.css('position', 'relative'))
    ...
    _attach: function (a) {
      ...
      b && -1 !== d.columns(this.c.columns).indexes().indexOf(b.column)
        ? (this.dom.offsetParent || (this.dom.offsetParent = c(d.table().node()).offsetParent()),
          (f.height && f.width) ||
            (e.appendTo('body'), (f.height = e.outerHeight()), (f.width = e.outerWidth())),
          (d = this._getPosition(a, this.dom.offsetParent)),
          (this.dom.attachedTo = a),
          e
            .css({ top: d.top + a.offsetHeight - f.height, left: d.left + a.offsetWidth - f.width })
    ...
    _drawSelection: function (a, d) {
      ...
      var e = c(this.dom.start),
        f = {
          row: this.c.vertical ? b.rows({ page: 'current' }).nodes().indexOf(a.parentNode) : d.row,
          column: this.c.horizontal ? c(a).index() : d.column
        }
    ...
    _mousedown: function (a) {
      ...
      this.s.start = {
        row: b.rows({ page: 'current' }).nodes().indexOf(c(this.dom.start).parent()[0]),
        column: c(this.dom.start).index()
      }
      c(g.body)
      ...
      a = this.dom.dtScroll
      this.s.scroll = {
        windowHeight: c(h).height(),
        windowWidth: c(h).width(),
      ...
      if (e.row !== f.row || e.column !== f.column) {
        ...
        if (c('div.DTE', m.node()).length) {
          ...
          for (
            var q = b.settings()[0],
              v = q.aoColumns,
              u = b.columns(this.c.columns).indexes(),
              w = 0;
            w < p.length;
            w++
          )
            f.push(
              c.map(e, function (t) {
                ...
                if (-1 !== u.indexOf(z.column))
                  return { cell: t, data: x, label: t.data(), index: z }
              })
            )
    ...
    _shiftScroll: function (a) {
      ...
      null !== b.dtTop && a.pageY < b.dtTop + 65
        ? (q = -5)
        : null !== b.dtTop && a.pageY > b.dtTop + b.dtHeight - 65 && (q = 5)
      null !== b.dtLeft && a.pageX < b.dtLeft + 65
        ? (v = -5)
        : null !== b.dtLeft && a.pageX > b.dtLeft + b.dtWidth - 65 && (v = 5)
      n || p || q || v
        ? ((b.windowVert = n), (b.windowHoriz = p), (b.dtVert = q), (b.dtHoriz = v), (e = !0))
  ...
  r.actions = {
    increment: {
      ...
      execute: function (a, d, b) {
        ...
        b = 1 * c('input', b).val()
        for (var e = 0, f = d.length; e < f; e++)
          for (var m = 0, n = d[e].length; m < n; m++) (d[e][m].set = a), (a += b)
      }
    },
    fill: {
      available: function (a, d) {
      ...
      execute: function (a, d, b) {
        ...
        for (var e = d.length; b < e; b++)
          for (var f = 0, m = d[b].length; f < m; f++) d[b][f].set = a
      }
    },
    fillHorizontal: {
      available: function (a, d) {
      ...
      execute: function (a, d, b) {
        ...
        for (b = d.length; a < b; a++)
          for (var e = 0, f = d[a].length; e < f; e++) d[a][e].set = d[a][0].data
      }
    },
    fillVertical: {
      available: function (a, d) {
      ...
      execute: function (a, d, b) {
        a = 0
        for (b = d.length; a < b; a++)
          for (var e = 0, f = d[a].length; e < f; e++) d[a][e].set = d[0][e].data
      }
    },
    cancel: {
      available: function () {
  ...
  c(g).on('preInit.dt.autofill', function (a, d, b) {
    'dt' === a.namespace &&
      ((a = d.oInit.autoFill), (b = l.defaults.autoFill), a || b) &&
      ((b = c.extend({}, a, b)), !1 !== a && new r(d, b))
  })
  l.AutoFill = r
  return (l.AutoFill = r)
})
