...
$jscomp.polyfill = function (k, m, l, h) {
  m &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(k, m, l, h)
      : $jscomp.polyfillUnisolated(k, m, l, h))
}
$jscomp.polyfillUnisolated = function (k, m, l, h) {
  ...
  h = l[k]
  m = m(h)
  m != h && null != m && $jscomp.defineProperty(l, k, { configurable: !0, writable: !0, value: m })
}
$jscomp.polyfillIsolated = function (k, m, l, h) {
  ...
  null != m &&
    (k
      ? $jscomp.defineProperty($jscomp.polyfills, p, { configurable: !0, writable: !0, value: m })
      : m !== l &&
        ...
        $jscomp.defineProperty(h, p, { configurable: !0, writable: !0, value: m })))
}
$jscomp.polyfill(
  'Object.is',
  function (k) {
...
$jscomp.polyfill(
  ...
  function (k) {
    ...
    for (
      ...
      'function' === typeof h &&
        'function' != typeof h.prototype[k] &&
        $jscomp.defineProperty(h.prototype, k, {
          configurable: !0,
          writable: !0,
          value: function () {
  ...
  function (k) {
    return k
      ...
      : function (m, l) {
          ...
          for (var v = 0; v < t && l < p; ) if (h[l++] != m[v++]) return !1
          return v >= t
        }
  },
  'es6',
  ...
  function (k) {
    return k
      ...
      : function (m, l) {
          ...
          void 0 === l && (l = h.length)
          l = Math.max(0, Math.min(l | 0, h.length))
          for (var p = m.length; 0 < p && 0 < l; ) if (h[--l] != m[--p]) return !1
          return 0 >= p
        }
  },
  'es6',
  ...
  var h,
    ...
    r = (function () {
      function c(a, b, d, e, f) {
        ...
        this.dom = {
          ...
          condition: h('<select disabled/>')
            .addClass(this.classes.condition)
            .addClass(this.classes.dropDown)
            .addClass(this.classes.italic)
            .attr('autocomplete', 'hacking'),
          conditionTitle: h('<option value="" disabled selected hidden/>').html(
            this.s.dt.i18n('searchBuilder.condition', b.condition)
          ),
          ...
          data: h('<select/>')
            ...
            .addClass(this.classes.dropDown)
            .addClass(this.classes.italic),
          dataTitle: h('<option value="" disabled selected hidden/>').html(
            this.s.dt.i18n('searchBuilder.data', b.data)
          ),
          defaultValue: h('<select disabled/>')
            .addClass(this.classes.value)
            .addClass(this.classes.dropDown)
            .addClass(this.classes.select)
            .addClass(this.classes.italic),
          delete: h('<button/>')
            .html(this.s.dt.i18n('searchBuilder.delete', b['delete']))
            .addClass(this.classes['delete'])
            .addClass(this.classes.button)
            .attr('title', this.s.dt.i18n('searchBuilder.deleteTitle', b.deleteTitle))
            .attr('type', 'button'),
          left: h('<button/>')
            .html(this.s.dt.i18n('searchBuilder.left', b.left))
            .addClass(this.classes.left)
            .addClass(this.classes.button)
            .attr('title', this.s.dt.i18n('searchBuilder.leftTitle', b.leftTitle))
            .attr('type', 'button'),
          right: h('<button/>')
            .html(this.s.dt.i18n('searchBuilder.right', b.right))
            .addClass(this.classes.right)
            .addClass(this.classes.button)
            .attr('title', this.s.dt.i18n('searchBuilder.rightTitle', b.rightTitle))
            .attr('type', 'button'),
          value: [
            h('<select disabled/>')
              .addClass(this.classes.value)
          ...
          valueTitle: h('<option value="--valueTitle--" disabled selected hidden/>').html(
            this.s.dt.i18n('searchBuilder.value', b.value)
          )
        }
        if (this.c.greyscale)
          for (
      ...
      c.prototype.updateArrows = function (a, b) {
        ...
        for (var d = 1; d < this.dom.value.length; d++)
          this.dom.container.append(this.dom.value[d]), this.dom.value[d].trigger('dtsb-inserted')
        1 < this.s.depth && this.dom.buttons.append(this.dom.left)
        ;(!1 === this.c.depthLimit || this.s.depth < this.c.depthLimit) && a
      ...
      c.prototype.search = function (a, b) {
        ...
        if (void 0 !== this.s.condition && void 0 !== d) {
          ...
          if (
            ...
            e = [a[this.s.dataIdx]]
            '' !== this.s.dt.settings()[0].oLanguage.sDecimal &&
              (e = a[this.s.dataIdx].split(this.s.dt.settings()[0].oLanguage.sDecimal))
            if ('' !== this.s.dt.settings()[0].oLanguage.sThousands)
              for (a = 0; a < e.length; a++)
                e[a] = e[a].replace(this.s.dt.settings()[0].oLanguage.sThousands, ',')
            e = e.join('.')
          }
          'filter' !== this.c.orthogonal.search &&
            ((e = this.s.dt.settings()[0]),
            (e = e.oApi._fnGetCellData(
              e,
              b,
              this.s.dataIdx,
              'string' === typeof this.c.orthogonal ? this.c.orthogonal : this.c.orthogonal.search
            )))
      ...
      c.prototype.getDetails = function (a) {
        ...
        if (
          ...
          for (a = 0; a < this.s.value.length; a++) {
            ...
            '' !== this.s.dt.settings()[0].oLanguage.sDecimal &&
              (b = this.s.value[a].split(this.s.dt.settings()[0].oLanguage.sDecimal))
            if ('' !== this.s.dt.settings()[0].oLanguage.sThousands)
              for (var d = 0; d < b.length; d++)
                b[d] = b[d].replace(this.s.dt.settings()[0].oLanguage.sThousands, ',')
            this.s.value[a] = b.join('.')
          }
        else if (null !== this.s.type && a)
          if (this.s.type.includes('date') || this.s.type.includes('time'))
            for (a = 0; a < this.s.value.length; a++)
              null === this.s.value[a].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) &&
                (this.s.value[a] = '')
          else if (this.s.type.includes('moment'))
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] = t(this.s.value[a], this.s.dateFormat).toISOString()
          else if (this.s.type.includes('luxon'))
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] = v.DateTime.fromFormat(this.s.value[a], this.s.dateFormat).toISO()
        if (this.s.type.includes('num') && this.s.dt.page.info().serverSide)
          for (a = 0; a < this.s.value.length; a++)
            this.s.value[a] = this.s.value[a].replace(/[^0-9.]/g, '')
        return {
      ...
      c.prototype.populate = function () {
        this._populateData()
        ;-1 !== this.s.dataIdx &&
          (this._populateCondition(), void 0 !== this.s.condition && this._populateValue())
      }
      c.prototype.rebuild = function (a) {
        ...
        if (void 0 !== a.data) {
          ...
          this.dom.data.children('option').each(function () {
            !b &&
            (h(this).text() === a.data || (a.origData && h(this).prop('origData') === a.origData))
              ? (h(this).prop('selected', !0), f.removeClass(e), (b = !0), (d = h(this).val()))
              : h(this).removeProp('selected')
          })
        }
        if (b) {
          this.s.data = a.data
          ...
          for (
            var g = void 0, n = this.dom.condition.children('option'), q = 0;
            q < n.length;
            q++
          ) {
            var u = h(n[q])
            void 0 !== a.condition && u.val() === a.condition && 'string' === typeof a.condition
              ? (u.prop('selected', !0), (g = u.val()))
              : u.removeProp('selected')
          }
          this.s.condition = g
          if (void 0 !== this.s.condition) {
            ...
            for (q = 0; q < n.length; q++)
              (u = h(n[q])), u.val() !== this.s.condition && u.removeProp('selected')
      ...
      c.prototype.setListeners = function () {
        ...
        this.dom.data.unbind('change').on('change.dtsb', function () {
          ...
          for (
            var b = a.dom.data.children('option.' + a.classes.option), d = 0;
            d < b.length;
            d++
          ) {
            var e = h(b[d])
            e.val() === a.dom.data.val()
              ? (a.dom.data.removeClass(a.classes.italic),
                e.prop('selected', !0),
                (a.s.dataIdx = +e.val()),
                (a.s.data = e.text()),
                (a.s.origData = e.prop('origData')),
        ...
        this.dom.condition.unbind('change').on('change.dtsb', function () {
          ...
          for (
            var b = a.dom.condition.children('option.' + a.classes.option), d = 0;
            d < b.length;
            d++
          ) {
            var e = h(b[d])
            if (e.val() === a.dom.condition.val()) {
              ...
              a._populateValue()
              e = 0
              for (f = a.dom.value; e < f.length; e++)
                (g = f[e]),
                  a.s.filled &&
                    void 0 !== g &&
                    0 !== a.dom.container.has(g[0]).length &&
                    ((a.s.filled = !1), a.s.dt.draw(), a.setListeners())
              ;(0 === a.dom.value.length ||
                (1 === a.dom.value.length && void 0 === a.dom.value[0])) &&
                a.s.dt.draw()
        ...
        if (0 !== h(document).has(this.dom.container).length) {
          ...
          if (void 0 !== a && 0 !== this.dom.container.has(a[0]).length) {
            ...
            var d = this.dom.left.offset(),
              ...
              q = g ? d.left : n ? e.left : f.left
            ;(15 > q - a || (g && d.top !== f.top) || (n && e.top !== f.top)) &&
              ...
              : 15 <
                  q -
                    (this.dom.data.offset().left +
                      this.dom.data.outerWidth(!0) +
                      this.dom.condition.outerWidth(!0) +
                      b) &&
                this.dom.container.parent().hasClass(this.classes.vertical) &&
      ...
      c.prototype._clearValue = function () {
        if (void 0 !== this.s.condition) {
          ...
          this.dom.value = [].concat(
            this.s.conditions[this.s.condition].init(this, c.updateListener)
          )
          if (0 < this.dom.value.length && void 0 !== this.dom.value[0])
            for (
              this.dom.value[0].insertAfter(this.dom.condition).trigger('dtsb-inserted'), e = 1;
              e < this.dom.value.length;
              e++
            )
              this.dom.value[e].insertAfter(this.dom.value[e - 1]).trigger('dtsb-inserted')
        } else {
          a = function (f) {
            void 0 !== f &&
              setTimeout(function () {
      ...
      c.prototype._populateCondition = function () {
        ...
        if (0 === b) {
          ...
          if (void 0 !== d)
            if (((d = d[b]), void 0 !== d.searchBuilderType && null !== d.searchBuilderType))
              this.s.type = d.searchBuilderType
            else if (void 0 === this.s.type || null === this.s.type) this.s.type = d.sType
          if (null === this.s.type || void 0 === this.s.type)
          ...
          '' !== b &&
            this.s.type.indexOf(b) === this.s.type.length - b.length &&
            (this.s.type.includes('num-fmt')
              ? (this.s.type = this.s.type.replace(b, ''))
              : this.s.type.includes('num') && (this.s.type = this.s.type.replace(b, '')))
          var e =
          ...
          for (var f = 0, g = Object.keys(e); f < g.length; f++)
            (d = g[f]),
              null !== e[d] &&
                (this.s.dt.page.info().serverSide &&
                  e[d].init === c.initSelect &&
                  ((e[d].init = c.initInput),
                  (e[d].inputValue = c.inputValueInput),
                  (e[d].isInputValid = c.isInputValidInput)),
                (this.s.conditions[d] = e[d]),
                (b = e[d].conditionName),
                'function' === typeof b && (b = b(this.s.dt, this.c.i18n)),
                a.push(
                  h('<option>', { text: b, value: d })
          ...
          for (
            this.dom.condition.empty().removeAttr('disabled').addClass(this.classes.italic),
              e = 0,
              f = Object.keys(this.s.conditions);
            e < f.length;
            e++
          )
            (d = f[e]),
              (b = this.s.conditions[d].conditionName),
              'function' === typeof b && (b = b(this.s.dt, this.c.i18n)),
              (d = h('<option>', { text: b, value: d })
                .addClass(this.classes.option)
                .addClass(this.classes.notItalic)),
              void 0 !== this.s.condition &&
                this.s.condition === b &&
                (d.prop('selected', !0), this.dom.condition.removeClass(this.classes.italic)),
              a.push(d)
        else {
      ...
      c.prototype._populateData = function () {
        ...
        if (0 === this.s.dataPoints.length)
          this.s.dt.columns().every(function (g) {
            if (!0 === a.c.columns || a.s.dt.columns(a.c.columns).indexes().toArray().includes(g)) {
              ...
              n ||
                ((n = a.s.dt.settings()[0].aoColumns[g]),
                (g = {
                  index: g,
                  origData: n.data,
                  text: (void 0 === n.searchBuilderTitle ? n.sTitle : n.searchBuilderTitle).replace(
                    /(<([^>]+)>)/gi,
                    ''
                  )
                }),
                a.s.dataPoints.push(g),
                a.dom.data.append(
                  h('<option>', { text: g.text, value: g.index })
                    .addClass(a.classes.option)
                    .addClass(a.classes.notItalic)
                    .prop('origData', n.data)
                    .prop('selected', a.s.dataIdx === g.index ? !0 : !1)
                ),
                a.s.dataIdx === g.index && a.dom.dataTitle.removeProp('selected'))
            }
          })
        else
          for (
            var b = function (g) {
                d.s.dt.columns().every(function (q) {
                  ...
                  ;(void 0 === u.searchBuilderTitle ? u.sTitle : u.searchBuilderTitle).replace(
                    /(<([^>]+)>)/gi,
                    ''
                  ) === g.text && ((g.index = q), (g.origData = u.data))
                })
                var n = h('<option>', { text: g.text.replace(/(<([^>]+)>)/gi, ''), value: g.index })
                  .addClass(d.classes.option)
                  .addClass(d.classes.notItalic)
                  .prop('origData', g.origData)
                d.s.data === g.text &&
                  ((d.s.dataIdx = g.index),
                  d.dom.dataTitle.removeProp('selected'),
                  n.prop('selected', !0),
                  d.dom.data.removeClass(d.classes.italic))
                d.dom.data.append(n)
              },
              d = this,
              e = 0,
      ...
      c.prototype._populateValue = function (a) {
        ...
        if (3 < e.length) for (f = 2; f < e.length - 1; f++) h(e[f]).remove()
        void 0 !== a &&
          this.s.dt.columns().every(function (n) {
        ...
        for (f = 1; f < this.dom.value.length; f++)
          this.dom.value[f].insertAfter(this.dom.value[f - 1]).trigger('dtsb-inserted')
      ...
      c.initSelect = function (a, b, d, e) {
        ...
        var f = a.dom.data.children('option:selected').val(),
          ...
          n = a.s.dt.settings()[0]
        a.dom.valueTitle.prop('selected', !0)
        var q = h('<select/>')
          .addClass(c.classes.value)
          .addClass(c.classes.dropDown)
          .addClass(c.classes.italic)
          .addClass(c.classes.select)
          .append(a.dom.valueTitle)
          .on('change.dtsb', function () {
            h(this).removeClass(c.classes.italic)
            b(a, this)
          })
        a.c.greyscale && q.addClass(c.classes.greyscale)
        for (var u = [], D = [], H = 0; H < g.length; H++) {
          var z = g[H],
            A = n.oApi._fnGetCellData(
              n,
              z,
              f,
              'string' === typeof a.c.orthogonal ? a.c.orthogonal : a.c.orthogonal.search
            )
          A = 'string' === typeof A ? A.replace(/[\r\n\u2028]/g, ' ') : A
          z = n.oApi._fnGetCellData(
            n,
            z,
            f,
            'string' === typeof a.c.orthogonal ? a.c.orthogonal : a.c.orthogonal.display
          )
          'array' === a.s.type &&
            ((A = Array.isArray(A) ? A : [A]), (z = Array.isArray(z) ? z : [z]))
          var J = function (w, y) {
            a.s.type.includes('html') &&
              null !== w &&
              'string' === typeof w &&
              w.replace(/(<([^>]+)>)/gi, '')
            w = h('<option>', { type: Array.isArray(w) ? 'Array' : 'String', value: w })
              .data('sbv', w)
              .addClass(a.classes.option)
              .addClass(a.classes.notItalic)
              .html('string' === typeof y ? y.replace(/(<([^>]+)>)/gi, '') : y)
            y = w.val()
            ;-1 === u.indexOf(y) &&
              (u.push(y),
              D.push(w),
              null !== d && Array.isArray(d[0]) && (d[0] = d[0].sort().join(',')),
              null !== d &&
                w.val() === d[0] &&
                (w.prop('selected', !0),
                q.removeClass(c.classes.italic),
                a.dom.valueTitle.removeProp('selected')))
          }
          if (e) for (var F = 0; F < A.length; F++) J(A[F], z[F])
          else J(A, Array.isArray(z) ? z.join(', ') : z)
        }
        D.sort(function (w, y) {
          if ('array' === a.s.type || 'string' === a.s.type || 'html' === a.s.type)
            return w.val() < y.val() ? -1 : w.val() > y.val() ? 1 : 0
          if ('num' === a.s.type || 'html-num' === a.s.type)
            return +w.val().replace(/(<([^>]+)>)/gi, '') < +y.val().replace(/(<([^>]+)>)/gi, '')
              ? -1
              : +w.val().replace(/(<([^>]+)>)/gi, '') > +y.val().replace(/(<([^>]+)>)/gi, '')
              ? 1
              : 0
          if ('num-fmt' === a.s.type || 'html-num-fmt' === a.s.type)
            return +w.val().replace(/[^0-9.]/g, '') < +y.val().replace(/[^0-9.]/g, '')
              ? -1
              : +w.val().replace(/[^0-9.]/g, '') > +y.val().replace(/[^0-9.]/g, '')
              ? 1
              : 0
        })
            ...
            a._throttle(
              function (f) {
                ...
                if (
                  !(
                    a.c.enterSearch ||
                    (void 0 !== a.s.dt.settings()[0].oInit.search &&
                      a.s.dt.settings()[0].oInit.search['return'])
                  ) ||
                  13 === f
                )
                  return b(a, this)
      ...
      c.init2Input = function (a, b, d) {
        ...
        e = [
          ...
          h('<span>')
            .addClass(a.classes.joiner)
            .html(a.s.dt.i18n('searchBuilder.valueJoiner', a.c.i18n.valueJoiner)),
          h('<input/>')
            .addClass(c.classes.value)
            .addClass(c.classes.input)
            .on(
      ...
      c.initDate = function (a, b, d) {
        ...
        var e = a.s.dt.settings()[0].searchDelay,
          f = h('<input/>')
            .addClass(c.classes.value)
            .addClass(c.classes.input)
            .dtDateTime({ attachTo: 'input', format: a.s.dateFormat ? a.s.dateFormat : void 0 })
            .on(
              'change.dtsb',
              a._throttle(
                function () {
            ...
            .on(
              ...
              a.c.enterSearch ||
                ...
                ? function (g) {
                    a._throttle(
                      function () {
                        if (13 === (g.keyCode || g.which)) return b(a, this)
                      },
                      null === e ? 100 : e
                    )
                  }
      ...
      c.isInputValidSelect = function (a) {
        for (var b = !0, d = 0; d < a.length; d++) {
          var e = a[d]
          e.children('option:selected').length ===
            e.children('option').length - e.children('option.' + c.classes.notItalic).length &&
            1 === e.children('option:selected').length &&
            e.children('option:selected')[0] === e.children('option')[0] &&
            (b = !1)
        }
        return b
      }
      ...
      c.inputValueSelect = function (a) {
        for (var b = [], d = 0; d < a.length; d++) {
          var e = a[d]
          e.is('select') && b.push(c._escapeHTML(e.children('option:selected').data('sbv')))
        }
        return b
      }
      c.inputValueInput = function (a) {
        for (var b = [], d = 0; d < a.length; d++) {
          var e = a[d]
          e.is('input') && b.push(c._escapeHTML(e.val()))
        }
        return b
      }
        ...
        if (a.s.filled) {
          ...
          for (d = 0; d < a.s.value.length; d++)
            if (Array.isArray(a.s.value[d])) a.s.value[d].sort()
              ...
              a.s.type.includes('num') &&
              ('' !== a.s.dt.settings()[0].oLanguage.sDecimal ||
                '' !== a.s.dt.settings()[0].oLanguage.sThousands)
            ) {
              var e = [a.s.value[d].toString()]
              '' !== a.s.dt.settings()[0].oLanguage.sDecimal &&
                (e = a.s.value[d].split(a.s.dt.settings()[0].oLanguage.sDecimal))
              if ('' !== a.s.dt.settings()[0].oLanguage.sThousands)
                for (var f = 0; f < e.length; f++)
                  e[f] = e[f].replace(a.s.dt.settings()[0].oLanguage.sThousands, ',')
              a.s.value[d] = e.join('.')
            }
          f = e = null
          for (d = 0; d < a.dom.value.length; d++)
            b === a.dom.value[d][0] &&
              ((e = d), void 0 !== b.selectionStart && (f = b.selectionStart))
          a.s.dt.draw()
          null !== e &&
            (a.dom.value[e].removeClass(a.classes.italic),
            a.dom.value[e].focus(),
            null !== f && a.dom.value[e][0].setSelectionRange(f, f))
        } else a.s.dt.draw()
      }
      c.dateConditions = {
        '=': {
      ...
      c.luxonDateConditions = {
        '=': {
          ...
          search: function (a, b, d) {
            return (
              v.DateTime.fromFormat(a, d.s.dateFormat).ts ===
              v.DateTime.fromFormat(b[0], d.s.dateFormat).ts
            )
          }
        },
        '!=': {
      ...
      c.stringConditions = {
        '=': {
          conditionName: function (a, b) {
            return a.i18n('searchBuilder.conditions.string.equals', b.conditions.string.equals)
          },
          init: c.initSelect,
          inputValue: c.inputValueSelect,
          isInputValid: c.isInputValidSelect,
        ...
        starts: {
          conditionName: function (a, b) {
            return a.i18n(
              ...
              b.conditions.string.startsWith
            )
          },
          init: c.initInput,
          inputValue: c.inputValueInput,
        ...
        '!starts': {
          conditionName: function (a, b) {
            return a.i18n(
              ...
              b.conditions.string.notStartsWith
            )
          },
          init: c.initInput,
          inputValue: c.inputValueInput,
        ...
        '!contains': {
          conditionName: function (a, b) {
            return a.i18n(
              ...
              b.conditions.string.notContains
            )
          },
          init: c.initInput,
          inputValue: c.inputValueInput,
        ...
        '!ends': {
          conditionName: function (a, b) {
            return a.i18n(
              ...
              b.conditions.string.notEndsWith
            )
          },
          init: c.initInput,
          inputValue: c.inputValueInput,
        ...
        '=': {
          ...
          search: function (a, b) {
            if (a.length === b[0].length) {
              for (var d = 0; d < a.length; d++) if (a[d] !== b[0][d]) return !1
              return !0
            }
            return !1
          }
    ...
    G = (function () {
      function c(a, b, d, e, f, g) {
        ...
        void 0 === f && (f = !1)
        void 0 === g && (g = 1)
        if (!E || !E.versionCheck || !E.versionCheck('1.10.0'))
      ...
      c.prototype.getDetails = function (a) {
        ...
        for (
          var b = { criteria: [], logic: this.s.logic }, d = 0, e = this.s.criteria;
          d < e.length;
          d++
        )
          b.criteria.push(e[d].criteria.getDetails(a))
        return b
      }
      c.prototype.getNode = function () {
        return this.dom.container
      ...
      c.prototype.rebuild = function (a) {
        if (
          !(
            void 0 === a.criteria ||
            null === a.criteria ||
            (Array.isArray(a.criteria) && 0 === a.criteria.length)
          )
        ) {
          ...
          if (Array.isArray(a.criteria))
            for (var b = 0, d = a.criteria; b < d.length; b++)
              (a = d[b]),
                void 0 !== a.logic
                  ? this._addPrevGroup(a)
                  : void 0 === a.logic && this._addPrevCriteria(a)
          b = 0
          for (d = this.s.criteria; b < d.length; b++)
            (a = d[b]),
              a.criteria instanceof r &&
      ...
      c.prototype.redrawContents = function () {
        if (!this.s.preventRedraw) {
          ...
          this.s.criteria.sort(function (d, e) {
            return d.criteria.s.index < e.criteria.s.index
              ? -1
              : d.criteria.s.index > e.criteria.s.index
              ? 1
              : 0
          })
          this.setListeners()
          for (var a = 0; a < this.s.criteria.length; a++) {
            ...
            b instanceof r
              ? ((this.s.criteria[a].index = a),
                ...
                this.s.criteria[a].criteria.dom.container.insertBefore(this.dom.add),
                this._setCriteriaListeners(b),
                this.s.criteria[a].criteria.rebuild(this.s.criteria[a].criteria.getDetails()))
              : b instanceof c && 0 < b.s.criteria.length
              ? ((this.s.criteria[a].index = a),
                (this.s.criteria[a].criteria.s.index = a),
                this.s.criteria[a].criteria.dom.container.insertBefore(this.dom.add),
                b.redrawContents(),
                this._setGroupListeners(b))
      ...
      c.prototype.setupLogic = function () {
        ...
        if (1 > this.s.criteria.length)
          this.s.isChild ||
            (this.dom.container.trigger('dtsb-destroy'), this.dom.container.css('margin-left', 0))
        else {
          ...
          this.dom.logicContainer.offset({ left: b })
          b = this.dom.logicContainer.next()
          a = a.top
          b = B(b).offset().top
          this.dom.logicContainer.offset({ top: a - (a - b) })
      ...
      c.prototype.addCriteria = function (a, b) {
        ...
        null !== a &&
          ((e.c = a.c), (e.s = a.s), (e.s.depth = this.s.depth), (e.classes = a.classes))
        e.populate()
        a = !1
        for (var f = 0; f < this.s.criteria.length; f++)
          0 === f && this.s.criteria[f].criteria.s.index > e.s.index
            ? (e.getNode().insertBefore(this.s.criteria[f].criteria.dom.container), (a = !0))
            : f < this.s.criteria.length - 1 &&
              this.s.criteria[f].criteria.s.index < e.s.index &&
              this.s.criteria[f + 1].criteria.s.index > e.s.index &&
              (e.getNode().insertAfter(this.s.criteria[f].criteria.dom.container), (a = !0))
        a || e.getNode().insertBefore(this.dom.add)
        this.s.criteria.push({ criteria: e, index: d })
        this.s.criteria = this.s.criteria.sort(function (g, n) {
          return g.criteria.s.index - n.criteria.s.index
        })
        d = 0
        for (a = this.s.criteria; d < a.length; d++)
          (f = a[d]),
            f.criteria instanceof r && f.criteria.updateArrows(1 < this.s.criteria.length, b)
      ...
      c.prototype.checkFilled = function () {
        for (var a = 0, b = this.s.criteria; a < b.length; a++) {
          var d = b[a]
          if (
            (d.criteria instanceof r && d.criteria.s.filled) ||
            (d.criteria instanceof c && d.criteria.checkFilled())
          )
            return !0
        }
        return !1
      ...
      c.prototype._andSearch = function (a, b) {
        ...
        for (var d = 0, e = this.s.criteria; d < e.length; d++) {
          var f = e[d]
          if (!((f.criteria instanceof r && !f.criteria.s.filled) || f.criteria.search(a, b)))
            return !1
        }
        return !0
      }
      c.prototype._orSearch = function (a, b) {
        ...
        for (var d = !1, e = 0, f = this.s.criteria; e < f.length; e++) {
          ...
          if (g.criteria instanceof r && g.criteria.s.filled) {
            ...
            g.criteria instanceof c &&
            g.criteria.checkFilled() &&
            ((d = !0), g.criteria.search(a, b))
          )
            return !0
        }
        return !d
      ...
      c.prototype._removeCriteria = function (a, b) {
        ...
        if (1 >= this.s.criteria.length && this.s.isChild) this.destroy()
          ...
          for (var d = void 0, e = 0; e < this.s.criteria.length; e++)
            this.s.criteria[e].index === a.s.index &&
              (!b || this.s.criteria[e].criteria instanceof c) &&
              (d = e)
          void 0 !== d && this.s.criteria.splice(d, 1)
          for (e = 0; e < this.s.criteria.length; e++)
            (this.s.criteria[e].index = e), (this.s.criteria[e].criteria.s.index = e)
        }
      }
    ...
    I = (function () {
      function c(a, b) {
        ...
        this.dom = {
          clearAll: x(
            '<button type="button">' +
              a.i18n('searchBuilder.clearAll', this.c.i18n.clearAll) +
              '</button>'
          )
        ...
        if (void 0 === a.settings()[0]._searchBuilder) {
          ...
          if (this.s.dt.page.info().serverSide)
            this.s.dt.on('preXhr.dtsb', function (e, f, g) {
              ;(e = d.s.dt.state.loaded()) &&
                e.searchBuilder &&
                (g.searchBuilder = d._collapseArray(e.searchBuilder))
            })
      ...
      c.prototype._setUp = function (a) {
        ...
        if (!C.DateTime) {
          ...
          if (void 0 === d || d.includes(void 0) || d.includes(null)) {
            d = []
            for (var e = 0, f = this.s.dt.settings()[0].aoColumns; e < f.length; e++) {
              var g = f[e]
          ...
          if (void 0 === d || d.includes(void 0) || d.includes(null))
            x.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
              (d = this.s.dt.columns().type().toArray())
          for (f = 0; f < e[0].length; f++)
            if (
              ((g = d[e[0][f]]),
              (!0 === this.c.columns ||
                (Array.isArray(this.c.columns) && this.c.columns.includes(f))) &&
                (g.includes('date') || g.includes('moment') || g.includes('luxon')))
            )
              throw (
        ...
        a &&
          ...
          null !== a && void 0 !== a.searchBuilder
            ? (this.s.topGroup.rebuild(a.searchBuilder),
              ...
              this.s.dt.page.info().serverSide || this.s.dt.page(a.page).draw('page'),
              this.s.topGroup.setListeners())
            : !1 !== this.c.preDefined &&
      ...
      c.prototype._collapseArray = function (a) {
        if (void 0 === a.logic)
          ...
          for (var b = 0; b < a.criteria.length; b++)
            a.criteria[b] = this._collapseArray(a.criteria[b])
        return a
      }
      ...
      c.prototype._build = function () {
        ...
        x.fn.dataTable.ext.search.includes(this.s.search) ||
          ((this.s.search = function (e, f, g) {
        ...
        this.s.dt.on('destroy.dtsb', function () {
          ...
          for (var e = x.fn.dataTable.ext.search.indexOf(a.s.search); -1 !== e; )
            x.fn.dataTable.ext.search.splice(e, 1),
              (e = x.fn.dataTable.ext.search.indexOf(a.s.search))
          a.s.dt.off('.dtsb')
      ...
      c.prototype._checkClear = function () {
        0 < this.s.topGroup.s.criteria.length
          ? (this.dom.clearAll.insertAfter(this.dom.title), this._setClearListener())
          : this.dom.clearAll.remove()
      }
      c.prototype._filterChanged = function (a) {
        var b = this.c.filterChanged
        'function' === typeof b &&
          b(a, this.s.dt.i18n('searchBuilder.button', this.c.i18n.button, a))
      }
      c.prototype._setClearListener = function () {
        var a = this
  ...
  ;(function (c) {
    ...
    c.fn.dataTable.ext.buttons.searchBuilder = {
      action: function (f, g, n, q) {
        this.popover(q._searchBuilder.getNode(), { align: 'container', span: 'container' })
        void 0 !== q._searchBuilder.s.topGroup &&
          q._searchBuilder.s.topGroup.dom.container.trigger('dtsb-redrawContents')
        0 === q._searchBuilder.s.topGroup.s.criteria.length &&
          c('.' + c.fn.dataTable.Group.classes.add).click()
      },
      config: {},
      init: function (f, g, n) {
        var q = new c.fn.dataTable.SearchBuilder(
          f,
          c.extend(
            {
    ...
    c(b).on('preInit.dt.dtsp', function (f, g) {
      'dt' === f.namespace &&
        (g.oInit.searchBuilder || e.defaults.searchBuilder) &&
        (g._searchBuilder || d(g))
    })
    e.ext.feature.push({ cFeature: 'Q', fnInit: d })
