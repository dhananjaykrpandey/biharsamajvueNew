          ...
          a(this._config.doc.body).append(
            ...
            this._$modal
              ...
              .on('hidden.bs.modal', function () {
                return (
                  g._galleryName &&
                    (a(document).off('keydown.ekkoLightbox'), a(window).off('resize.ekkoLightbox')),
                  g._$modal.remove(),
          ...
          c(
            ...
            [
              ...
              },
              {
                ...
                value: function (a, b) {
                  return (
                    ...
                    (!b ||
                      ['image', 'youtube', 'vimeo', 'instagram', 'video', 'url'].indexOf(b) < 0) &&
                      (b = 'url'),
                    b
                  )
                }
                ...
                value: function () {
                  ...
                  return (
                    this._$lightboxBodyTwo.hasClass('in') &&
                      ((b = this._$lightboxBodyOne), (c = this._$lightboxBodyTwo)),
                  ...
                  return (
                    ...
                    b
                      ? (this._$modalDialog.css('display', 'none'),
                        ...
                        a('.modal-backdrop').append(this._config.loadingMessage))
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    (this._footerIsShown = !1),
                    b
                      ? ((this._footerIsShown = !0), this._$modalFooter.css('display', '').html(b))
              ...
              },
              {
                ...
                value: function (a, b) {
                  ...
                  return this._showVideoIframe(
                    '//www.youtube.com/embed/' + c + '?badge=0&autoplay=1&html5=1' + d,
                    e,
                    f,
                    b
                  )
                ...
                value: function (b, c) {
                  ...
                  return (
                    ...
                    g || this._isExternal(b)
                      ? (c.html(
                          '<iframe src="' + b + '" frameborder="0" allowfullscreen></iframe>'
                        ),
                        this._config.onContentLoaded.call(this))
                      : c.load(
                          b,
              ...
              },
              {
                ...
                value: function (a) {
                  return (
                    console.error(a), this._containerToUse().html(a), this._resize(300, 300), this
                  )
                }
              },
              {
                    ...
                    c &&
                      !(function () {
                        ...
                        ;(e.onload = function () {
                          ...
                          (e.onerror = function () {
                            return (
                              d._toggleLoading(!1), d._error(d._config.strings.fail + ('  ' + b))
                            )
                          })
                      })(),
                    (e.src = b),
