        ...
        [
          ...
          },
          {
            ...
            value: function _detectRemoteType(src, type) {
              ...
              if (
                !type ||
                ['image', 'youtube', 'vimeo', 'instagram', 'video', 'url'].indexOf(type) < 0
              )
                type = 'url'
          ...
          },
          {
            ...
            value: function _handle() {
              ...
              if (
                ['image', 'youtube', 'vimeo', 'instagram', 'video', 'url'].indexOf(currentType) < 0
              )
          ...
          },
          {
            ...
            value: function _resize(width, height) {
              ...
              var widthBorderAndPadding =
                this._padding.left + this._padding.right + this._border.left + this._border.right
