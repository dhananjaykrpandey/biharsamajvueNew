...
var JQVMap = function (a) {
  ...
  ;(this.selectedRegions = []),
    ...
    jQuery(window).resize(function () {
      ...
      if (d && e) {
        ...
        jQuery(a.container).trigger(f, [d, e]),
          b && (jQuery('.jqvmap-pin').remove(), (c.pinHandlers = !1), c.placePins(b.pins, b.mode))
      }
    }),
    ...
    a.enableZoom &&
      (jQuery('<div/>').addClass('jqvmap-zoomin').text('+').appendTo(a.container),
...
;(JQVMap.prototype = {
  ...
  (function () {
    ...
    jQuery.fn.vectorMap = function (c) {
      ...
      if ('addMap' === c) JQVMap.maps[arguments[1]] = arguments[2]
        ...
        e['set' + arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1)].apply(
          e,
      ...
      g =
        e === this.colors.length - 1
          ...
          : this.vectorToNum(
              this.vectorAdd(
                this.colors[e],
                this.vectorMult(this.vectorSubtract(this.colors[e + 1], this.colors[e]), a / c[e])
              )
            ).toString(16);
      g.length < 6;
  ...
  (JQVMap.prototype.applyTransform = function () {
    ...
    this.defaultWidth * this.scale <= this.width
      ...
      : ((a = 0), (c = (this.width - this.defaultWidth * this.scale) / this.scale)),
      this.defaultHeight * this.scale <= this.height
        ...
        : ((b = 0), (d = (this.height - this.defaultHeight * this.scale) / this.scale)),
  ...
  (JQVMap.prototype.deselect = function (a, b) {
    if (
      ((a = a.toLowerCase()), (b = b || jQuery('#' + this.getCountryId(a))[0]), this.isSelected(a))
    )
  ...
  (JQVMap.prototype.highlight = function (a, b) {
    ;(b = b || jQuery('#' + this.getCountryId(a))[0]),
      this.hoverOpacity
        ...
        ? ((b.currentFillColor = b.getFill() + ''), b.setFill(this.hoverColors[a]))
        : this.hoverColor && ((b.currentFillColor = b.getFill() + ''), b.setFill(this.hoverColor))
  }),
  ...
  (JQVMap.prototype.select = function (a, b) {
    ;(a = a.toLowerCase()),
      (b = b || jQuery('#' + this.getCountryId(a))[0]),
      this.isSelected(a) ||
        (this.multiSelectRegion ? this.selectedRegions.push(a) : (this.selectedRegions = [a]),
        jQuery(this.container).trigger('regionSelect.jqvmap', [a]),
        this.selectedColor &&
          b &&
          ((b.currentFillColor = this.selectedColor), b.setFill(this.selectedColor)))
  }),
  ...
  (JQVMap.prototype.setColors = function (a, b) {
    if ('string' == typeof a)
      ...
      for (var d in c)
        this.countries[d] &&
          (this.countries[d].setFill(c[d]), this.countries[d].setAttribute('original', c[d]))
    }
  }),
  ...
  (VectorCanvas.prototype.applyTransformParams = function (a, b, c) {
    'svg' === this.mode
      ? this.rootGroup.setAttribute('transform', 'scale(' + a + ') translate(' + b + ', ' + c + ')')
      : ((this.rootGroup.coordorigin = this.width - b + ',' + (this.height - c)),
  ...
  (VectorCanvas.prototype.pathSvgToVml = function (a) {
    var b,
      ...
      f = 0
    return a
      .replace(/([MmLlHhVvCcSs])((?:-?(?:\d+)?(?:\.\d+)?,?\s?)+)/g, function (a, g, h) {
