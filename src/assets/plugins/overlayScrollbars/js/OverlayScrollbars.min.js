...
!(function (n, t) {
      ...
      (l = {}),
      {
        ...
        v: function (n) {
          ...
          for (var r, e, i, o = c(n), u = hi.createElement('div')[xi.s], f = 0; f < a.length; f++)
            for (
              i = a[f].replace(/-/g, ''), r = [n, a[f] + n, i + o, c(i) + o], e = 0;
              e < r[xi.l];
              e++
            )
              if (u[r[e]] !== di) {
        ...
        d: function (n, t, r) {
          ...
          for (
            var o, u = hi.createElement('div')[xi.s], f = t.split(' '), a = r || '', c = 0, s = -1;
            c < f[xi.l];
            c++
          )
            for (; s < _i.e[xi.l]; s++)
      ...
      (M[xi.p] = {
        ...
        trigger: function (n) {
          ...
          return this.each(function () {
            ;(t = this),
              hi.createEvent
                ? ((r = hi.createEvent('HTMLEvents')).initEvent(n, !0, !1), t.dispatchEvent(r))
                : t.fireEvent('on' + n)
          })
        },
        append: function (n) {
        ...
        wrapAll: function (n) {
          for (
            var t, r = this, e = M(n)[0], i = e, o = r[0].parentNode, u = r[0].previousSibling;
            0 < i.childNodes[xi.l];
      ...
      (Ii = {
        g: (V = function (i) {
          var o = function (n) {
            ...
            for (t in n)
              n[xi.hOP](t) &&
                ((r = n[t]), (e = D(r)) == mi ? (n[t] = r[i ? 1 : 0]) : e == pi && (n[t] = o(r)))
            return n
          }
            ...
            ? ((n = n[xi.l] != di ? n : [n[0] || n]),
              ...
              0 < n[xi.l] &&
                (u
                  ...
                  : Ci.each(n, function (n, t) {
                      ;(i = Ti(t)),
                        (('!' === r && ki.valid(i)) || (Oi.type(r) == bi && r(t, i)) || r === di) &&
                          o.push(i)
                    }),
                (t = 1 === o[xi.l] ? o[0] : o)),
              t)
  ...
  function G(r) {
    ...
    ;(this.add = function (n) {
      ;-1 === e(n, h) &&
        (h.push(n), d.push(s()), 0 < h[v] && !p && ((p = !0), (r.autoUpdateLoop = p), g()))
    }),
      (this.remove = function (n) {
        ...
        ;-1 < t &&
          ...
          0 === h[v] &&
            p &&
            ((p = !1), (r.autoUpdateLoop = p), c !== di && (Oi.cAF()(c), (c = -1))))
      })
  }
  function K(r, n, t, xt, _t) {
              ...
              ? _
                ...
                : ((v = { duration: t, complete: F }),
                  Oi.isA(r) || Ci.isPlainObject(r)
                    ? ((z[_e] = r[0] || r.x), (z[Oe] = r[1] || r.y), (v.specialEasing = z))
                    : (v.easing = r),
                  Zt.animate(S, v))
          ...
          if (T)
            ...
            n.prepend(
              ui(
                ...
                ui(
                  { c: Sn, dir: 'ltr' },
                  ui(Sn, ui(zn)) + ui(Sn, ui({ c: zn, style: 'width: 200%; height: 200%' }))
                )
              )
            )
            var f,
    ...
    function Ve() {
      ...
      return (
        Rt &&
          tr &&
          ((n.w = ii(tr.css(ve + de))), (n.h = ii(tr.css(ve + pe))), (n.c = fi(n, Ur)), (n.f = !0)),
        !!(Ur = n).c
      )
    }
    function et(n, t) {
    ...
    function qe(n) {
      ...
      if (
        ...
        if (I && !J) {
          ...
          var tn = ur[xi.oW]
          rr.css(de, nn),
            (K = Z !== tn) || (rr.css(de, Z + 1), (tn = ur[xi.oW]), rr.css(de, nn), (K = Z !== tn))
        }
        var rn = (J || K) && I && !t,
          en = a(rn, br),
          on = !rn && br,
        ...
        if (
          ...
          ri(vn, oe, [-X.t, -X.r, -X.b, -X.l]),
            S ? (ri(mn, me, wn), ri(Lt ? gn : ln, ue)) : (ri(mn, me), ri(Lt ? gn : ln, ue, wn)),
            Jt.css(mn),
            Xt.css(gn)
        }
        ee = dn()
        ...
        if (
          ...
          rn
            ? ((vn[de] = ge), (ln[de] = _i.d(de, 'max-content intrinsic') || ge), (ln[be] = G))
            : (vn[de] = me),
          ...
          if (((Nn.c = a(Nn, zr)), (zr = Nn), I)) {
            ;(Nn.c || un || rn) &&
              ((vn[de] = Nn.w), (vn[pe] = Nn.h), Lt || (An = { w: Tn[xi.cW], h: Tn[xi.cH] }))
            var Wn = {},
              Mn = function (n) {
                var t = ni(n),
                  r = t.j,
            ...
            ;(Vn.x || Vn.y) &&
              ...
              (Vn.c || $n.c || Dn.c || V || en || fn || rn || un || H) &&
                ...
                (Gn = function (n) {
                  ...
                  St[e] && Vn[e] && $n[e + 's']
                    ? ((ln[oe + i] = !o || A ? me : zt[e]),
                      (ln[fe + i] = (n && o) || A ? me : zt[e] + 'px solid transparent'))
            ...
            (nt = function (n) {
              ...
              Vn[e] && $n[e + 's']
                ? ((tt[On + i] = we),
                  A || It
                    ? u()
                    : ((tt[o] = -(St[e] ? zt[e] : At[e])), (re[r.j] = St[e] ? zt[r.Q] : 0)))
                : ((tt[On + i] = me), u())
            })(!0),
            nt(!1),
            !It &&
          ...
          li(Yt, ke, $n.x || $n.y),
            ...
            ti(
              'onOverflowChanged',
              { x: Vn.x, y: Vn.y, xScrollable: $n.xs, yScrollable: $n.ys, clipped: $n.x || $n.y },
              Vn.c || $n.c
            ),
      ...
      ;(Yt = Yt || (Lt ? (p ? Xt[n]()[n]()[n]()[n]() : Ci(ui(on))) : Xt)),
        ...
        e
          ? (p && Ht
            ...
            Rt && si(c, tn))
          : (Lt &&
              (Vt.sizeAutoCapable || ((a[de] = Xt.css(de)), (a[pe] = Xt.css(pe))),
        ...
        : Yn(nr, J, function v(n) {
            !0 !== Tr &&
              (function l(n) {
                ...
                return (
                  ('s' === Cr.y || 'v-s' === Cr.y) && ((c = s(u, n)) || Nt || (c = s(f, n))),
        ...
        Yn(
          ...
          function h(n) {
            Ut ||
              (t !== di
                ? clearTimeout(t)
                : ((Yr || Gr) && Ge(!0), dt() || ci(Yt, Ce), ti('onScrollStart', n)),
              Q || (Je(!0), Je(!1)),
              ti('onScroll', n),
      ...
      if ((clearTimeout(k), n)) si(a, Ln), si(v, Ln)
        ...
        var r,
          e = function () {
            B ||
              Et ||
              (!(r = l.hasClass('active') || m.hasClass('active')) && (Yr || Gr || Kr) && ci(a, Ln),
              !r && (Yr || Gr || Kr) && ci(v, Ln))
          }
    ...
    function ht(n) {
      ...
      return typeof e[r] == pi
        ? n instanceof e[r]
        : n && typeof n == pi && null !== n && 1 === n.nodeType && typeof n.nodeName == gi
    }
    function ii(n, t) {
