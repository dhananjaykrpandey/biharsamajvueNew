    ...
    var DateTimePicker = /*#__PURE__*/ (function () {
            ...
            outpValue =
              (oldDate &&
                outpValue
                  ...
                  .replace(
                    '' + this._options.multidateSeparator + this._options.multidateSeparator,
                    ''
                  )
                  .replace(
                    new RegExp(escapeRegExp(this._options.multidateSeparator) + '\\s*$'),
                    ''
                  )) ||
              ''
      ...
      _proto._areSameDates = function _areSameDates(a, b) {
        ...
        return (
          a &&
          b &&
          (a.isSame(b) || moment(a.format(format), format).isSame(moment(b.format(format), format)))
        )
      }
  ...
  var TempusDominusBootstrap4 = (function ($) {
    ...
    var TempusDominusBootstrap4 = /*#__PURE__*/ (function (_DateTimePicker) {
      ...
      _proto2._fillDate = function _fillDate() {
        ...
        $('body')
          .find('.tempusdominus-bootstrap-datetimepicker-widget-day-click-glass-panel')
          .remove()
      ...
      _proto2._fillTime = function _fillTime() {
        ...
        if (!this.use24Hours) {
          ...
          newDate = lastPickedDate
            ? lastPickedDate.clone().add(lastPickedDate.hours() >= 12 ? -12 : 12, 'h')
            : void 0
        ...
        lastPickedDate &&
          timeComponents.filter('[data-time-component=minutes]').text(lastPickedDate.format('mm'))
        lastPickedDate &&
          timeComponents.filter('[data-time-component=seconds]').text(lastPickedDate.format('ss'))
