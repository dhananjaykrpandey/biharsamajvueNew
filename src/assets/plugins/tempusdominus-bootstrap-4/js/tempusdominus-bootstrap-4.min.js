      ...
      (v = {
        ...
        keyBinds: {
          ...
          right: function () {
            ...
            var t = this._dates[0] || this.getMoment()
            return (
              this.widget.find('.datepicker').is(':visible') && this.date(t.clone().add(1, 'd')), !0
            )
          },
          pageUp: function () {
            if (!this.widget) return !1
          ...
          pageDown: function () {
            ...
            var t = this._dates[0] || this.getMoment()
            return (
              this.widget.find('.datepicker').is(':visible') && this.date(t.clone().add(1, 'M')), !0
            )
          },
          enter: function () {
        ...
        return (
          (i._int = function () {
            ...
            this._element.is('input')
              ...
              : void 0 !== t && (this.input = 'nearest' === t ? this._element.find('input') : a(t)),
              (this._dates = []),
          ...
          (i._setValue = function (t, e) {
                    ...
                    : ((o = '' + this._element.data('date') + this._options.multidateSeparator),
                      (o =
                        (d &&
                          o
                            .replace(
                              '' + d.format(this.actualFormat) + this._options.multidateSeparator,
                              ''
                            )
                            .replace(
                              '' +
            ...
            if (
              ...
              1 !== this._options.stepping &&
                t
                  .minutes(
                    Math.round(t.minutes() / this._options.stepping) * this._options.stepping
                  )
                  .seconds(0),
              this._isValid(t))
            ) {
              ...
              if (
                ...
                for (var h = 0; h < this._dates.length; h++)
                  o +=
                    '' + this._dates[h].format(this.actualFormat) + this._options.multidateSeparator
              ...
              (r = !0),
                this._options.keepInvalid
                  ...
                  : void 0 !== this.input &&
                    (this.input.val(
                      '' + (this.unset ? '' : this._dates[e].format(this.actualFormat))
                    ),
          ...
          (i._handlePromptTimeIfNeeded = function (t) {
            if (this._options.promptTimeOnDateChange) {
              ...
              if (
                t.oldDate &&
                t.date &&
                (t.oldDate.format('YYYY-MM-DD') === t.date.format('YYYY-MM-DD') ||
                  (t.oldDate.format('YYYY-MM-DD') !== t.date.format('YYYY-MM-DD') &&
          ...
          (i._keyup = function (t) {
            ;(w[t.which] = 'r'),
              g[t.which] && ((g[t.which] = !1), t.stopPropagation(), t.preventDefault())
          }),
          ...
          (i._initFormatting = function () {
            ...
            ;(this.actualFormat = t.replace(
              ...
              function (t) {
                return (
                  (e.isInitFormatting && null === e._options.date ? e.getMoment() : e._dates[0])
                    .localeData()
                    .longDateFormat(t) || t
                )
              }
          ...
          (i.date = function (t, e) {
            if (((e = e || 0), 0 === arguments.length))
              return this.unset
                ...
                : this._dates[e].clone()
            if (!(null === t || 'string' == typeof t || n.isMoment(t) || t instanceof Date))
          ...
          (i.format = function (t) {
            ...
            if ('string' != typeof t && ('boolean' != typeof t || !1 !== t))
              throw new TypeError('format() expects a string or boolean:false parameter ' + t)
          ...
          (i.maxDate = function (t) {
            ...
            this._viewDate.isAfter(e) &&
              (this._viewDate = e.clone().subtract(this._options.stepping, 'm')),
              this._update()
          }),
          ...
          (i.defaultDate = function (t) {
            ...
            'string' == typeof t &&
              (t = 'now' === t || 'moment' === t ? this.getMoment() : this.getMoment(t))
            var e = this._parseInputDate(t)
            if (!e.isValid())
              throw new TypeError('defaultDate() Could not parse date parameter: ' + t)
            if (!this._isValid(e))
              throw new TypeError(
          ...
          (i.locale = function (t) {
            ...
            if (!n.localeData(t))
              throw new TypeError('locale() locale ' + t + ' is not loaded from moment locales!')
          ...
          (i.useCurrent = function (t) {
            ...
            if ('string' == typeof t && -1 === e.indexOf(t.toLowerCase()))
              throw new TypeError('useCurrent() expects a string parameter of ' + e.join(', '))
          ...
          (i.viewMode = function (t) {
            ...
            if (-1 === p.ViewModes.indexOf(t))
              throw new TypeError(
                'viewMode() parameter must be one of (' + p.ViewModes.join(', ') + ') value'
              )
            ;(this._options.viewMode = t),
              (this.currentViewMode = Math.max(p.ViewModes.indexOf(t) - 1, this.MinViewModeNumber)),
              this._showMode()
          }),
          ...
          (i.viewDate = function (t) {
            ...
            ;(this._viewDate = this._parseInputDate(t)),
              this._update(),
              this._viewUpdate(_[this.currentViewMode] && _[this.currentViewMode].NAV_FUNCTION)
          }),
    ...
    (x = (function (d) {
      ...
      return (
        ...
        (i._iconTag = function (t) {
          return 'undefined' != typeof feather && this._useFeatherIcons() && feather.icons[t]
        ...
        (i._getDatePickerTemplate = function () {
          var t = E('<thead>').append(
            ...
            e = E('<tbody>').append(
              E('<tr>').append(E('<td>').attr('colspan', this._options.calendarWeeks ? '8' : '7'))
            )
          return [
            E('<div>')
            ...
            E('<div>')
              ...
              .append(E('<table>').addClass('table-condensed').append(t.clone()).append(e.clone())),
            E('<div>')
            ...
            !this._options.sideBySide &&
              ...
              ((e =
                'times' === this._options.viewMode
                  ? ((t = this._options.tooltips.selectDate), this._options.icons.date)
                  : ((t = this._options.tooltips.selectTime), this._options.icons.time)),
              i.push(
                E('<td>').append(
                  E('<a>')
                    .attr({ href: '#', tabindex: '-1', 'data-action': 'togglePicker', title: t })
        ...
        (i._place = function (t) {
          ...
          if (
            ('auto' === s &&
              (s =
                o.top + 1.5 * i.widget.height() >= E(window).height() + E(window).scrollTop() &&
          ...
          i.widget.css({
            ...
            right:
              'left' === a
                ? 'auto'
                : e.outerWidth() - i._element.outerWidth() - (e === i._element ? 0 : n.left) + 'px'
          })
        }),
        (i._fillDow = function () {
          var t = E('<tr>'),
          ...
          for (
            !0 === this._options.calendarWeeks && t.append(E('<th>').addClass('cw').text('#'));
            e.isBefore(this._viewDate.clone().endOf('w'));

          )
            t.append(E('<th>').addClass('dow').text(e.format('dd'))), e.add(1, 'd')
        ...
        (i._fillMonths = function () {
          for (
            ...
            t.push(
              E('<span>').attr('data-action', 'selectMonth').addClass('month').text(e.format('MMM'))
            ),
              e.add(1, 'M')
        ...
        (i._updateYears = function () {
          ...
          for (
            ...
            (n +=
              ...
              (s.isSame(this._getLastPickedDate(), 'y') && !this.unset ? ' active' : '') +
              (this._isValid(s, 'y') ? '' : ' disabled') +
              '">' +
              s.year() +
              '</span>'),
        ...
        (i._updateDecades = function () {
          ...
          for (
            i.eq(0).find('span').attr('title', this._options.tooltips.prevCentury),
              ...
              (0 === a.year() ||
                (this._options.minDate && this._options.minDate.isAfter(a, 'y'))) &&
        ...
        (i._fillDate = function () {
          ...
          if (this._hasDate()) {
            for (
              ...
              0 === t.weekday() &&
                ((e = E('<tr>')),
                this._options.calendarWeeks && e.append('<td class="cw">' + t.week() + '</td>'),
                r.push(e)),
                (i = ''),
                t.isBefore(this._viewDate, 'M') && (i += ' old'),
                t.isAfter(this._viewDate, 'M') && (i += ' new'),
                this._options.allowMultidate
                  ? -1 !== (a = this._datesFormatted.indexOf(t.format('YYYY-MM-DD'))) &&
        ...
        (i._fillTime = function () {
          ...
          this.use24Hours ||
            ...
            s &&
              i.filter('[data-time-component=hours]').text(s.format(this.use24Hours ? 'HH' : 'hh')),
        ...
        (i._doAction = function (t, e) {
          ...
          switch ((e = e || E(t.currentTarget).data('action'))) {
            case 'next':
              ...
              this._viewDate.add(M.DatePickerModes[this.currentViewMode].NAV_STEP, s),
                this._fillDate(),
                this._viewUpdate(s)
              break
            case 'previous':
              var a = M.DatePickerModes[this.currentViewMode].NAV_FUNCTION
              this._viewDate.subtract(M.DatePickerModes[this.currentViewMode].NAV_STEP, a),
                this._fillDate(),
                this._viewUpdate(a)
              break
            case 'pickerSwitch':
            ...
            case 'selectMonth':
              ...
              this._viewDate.month(n),
                this.currentViewMode === this.MinViewModeNumber
                  ? (this._setValue(
                      i.clone().year(this._viewDate.year()).month(this._viewDate.month()),
            ...
            case 'togglePicker':
              ...
              if (D && D.length) {
                ...
                D.collapse
                  ...
                  this._useFeatherIcons()
                    ? (v.toggleClass(this._options.icons.time + ' ' + this._options.icons.date),
          ...
          this.widget &&
            ...
            e ||
              ...
              void 0 !== this.input &&
                ...
                0 !== this.input.val().trim().length &&
                this._setValue(
                  this._parseInputDate(this.input.val().trim(), { isPickerShow: !1 }),
                  0
                ),
        ...
        (i.show = function () {
          ...
          if (void 0 !== this.input) {
            ...
            void 0 !== this.input.val() && 0 !== this.input.val().trim().length
              ? this._setValue(
                  this._parseInputDate(this.input.val().trim(), { isPickerShow: !0 }),
                  0
                )
              : (e = !0)
          } else e = !0
        ...
        (i.toolbarPlacement = function (t) {
          ...
          if (-1 === T.indexOf(t))
            throw new TypeError(
              'toolbarPlacement() parameter must be one of (' + T.join(', ') + ') value'
            )
        ...
        (i.widgetPositioning = function (t) {
          ...
          if (t.horizontal) {
            ...
            if (((t.horizontal = t.horizontal.toLowerCase()), -1 === C.indexOf(t.horizontal)))
              throw new TypeError(
          ...
          if (t.vertical) {
            ...
            if (((t.vertical = t.vertical.toLowerCase()), -1 === p.indexOf(t.vertical)))
              throw new TypeError(
                'widgetPositioning() expects vertical parameter to be one of (' + p.join(', ') + ')'
              )
    ...
    E(document)
      .on(M.Event.CLICK_DATA_API, M.Selector.DATA_TOGGLE, function () {
        var t = E(this),
          ...
          i = e.data(M.DATA_KEY)
        0 !== e.length &&
          ((i._options.allowInputToggle && t.is('input[data-toggle="datetimepicker"]')) ||
      ...
      .on(M.Event.BLUR, '.' + M.ClassName.INPUT, function (t) {
        var e = I(E(this)),
          i = e.data(M.DATA_KEY)
        0 !== e.length &&
          (i._options.debug || window.debug || x._jQueryInterface.call(e, 'hide', t))
      })
