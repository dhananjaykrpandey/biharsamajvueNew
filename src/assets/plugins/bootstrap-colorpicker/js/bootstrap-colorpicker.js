  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var sliderSize =
          sassVars.bar_size_short * sassVars.columns + sassVars.base_margin * (sassVars.columns - 1)
        ...
        _jquery2.default.fn[plugin] = function (option) {
          ...
          var $elements = this.each(function () {
            var $this = (0, _jquery2.default)(this),
              ...
              options =
                (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object'
                  ? option
                  : {}
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Colorpicker = (function () {
          ...
          function Colorpicker(element, options) {
            ...
            this.container =
              this.container !== false ? (0, _jquery2.default)(this.container) : false
              ...
              value: function setValue(val) {
                ...
                ch.color = val
                  ? ch.createColor(
                      ...
                      this.options.autoHexInputFallback
                    )
                  : null
          ...
          _createClass(Debugger, [
            ...
            },
            {
              ...
              value: function onCreate(event) {
                ...
                return _get(
                  Debugger.prototype.__proto__ || Object.getPrototypeOf(Debugger.prototype),
                  'onCreate',
                  this
                ).call(this, event)
              }
          ...
          _createClass(Preview, [
            {
              ...
              value: function onCreate(event) {
                _get(
                  Preview.prototype.__proto__ || Object.getPrototypeOf(Preview.prototype),
                  'onCreate',
                  this
                ).call(this, event)
              ...
              value: function onUpdate(event) {
                ...
                if (this.options.showText) {
                  this.elementInner.html(
                    event.color.string(this.options.format || this.colorpicker.format)
                  )
        ...
        var Swatches = (function (_Palette) {
          ...
          _createClass(Swatches, [
            ...
            },
            {
              ...
              value: function onCreate(event) {
                _get(
                  Swatches.prototype.__proto__ || Object.getPrototypeOf(Swatches.prototype),
                  'onCreate',
                  this
                ).call(this, event)
                  ...
                  var $swatch = (0, _jquery2.default)(_this2.options.swatchTemplate)
                    ...
                    .on('mousedown.colorpicker touchstart.colorpicker', function (e) {
                      ...
                      colorpicker.setValue(
                        isAliased ? $sw.attr('data-name') : $sw.attr('data-value')
                      )
                    })
          ...
          _createClass(PopupHandler, [
            {
              ...
              value: function bind() {
                ...
                if (this.hasAddon) {
                  ...
                  this.addon.on({
                    'mousedown.colorpicker touchstart.colorpicker': _jquery2.default.proxy(
                      this.toggle,
                      this
                    )
                  })
            ...
            },
            {
              ...
              value: function createPopover() {
                ...
                this.popoverTarget.popover(
                  _jquery2.default.extend(true, {}, _options2.default.popover, cp.options.popover, {
                    trigger: 'manual',
                    content: cp.picker,
                    html: true
                  })
              ...
              value: function _supportsAlphaBar() {
                return (
                  (this.options.useAlpha ||
                    (this.colorpicker.colorHandler.hasColor() && this.color.hasTransparency())) &&
                  this.options.useAlpha !== false &&
                  (!this.options.format ||
                    (this.options.format && !this.options.format.match(/^hex([36])?$/i)))
                )
              }
