      ...
      if (a.hasOwnProperty('html')) var k = d(a.html)
        ...
        k = d('<' + g + '/>')
          ...
          .on('keypress.dtb', function (w) {
            13 === w.keyCode &&
              (w.preventDefault(), !k.hasClass(h.disabled) && a.action && t(w, r, k, a))
          })
    ...
    _popover: function (a, b, c, e) {
      ...
      var h = !1,
        ...
        l = function () {
          ...
          d(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr(
            'aria-expanded',
            'false'
          )
      ...
      if (!1 === a) l()
        ...
        if ('absolute' === r) {
          ...
          if ('dt-container' === f.align || 'container' === f.align)
            y < c.left && (y = -c.left), y + v.width > n.width && (y = n.width - v.width)
          ...
          d('body')
            .on('click.dtb-collection', function (E) {
              if (!h) {
                ...
                ;((!d(E.target).parents()[A]().filter(a).length && !d(w).hasClass('dt-buttons')) ||
