...
;(function (f) {
  ...
  function t(a, b, c) {
    ...
    c &&
      (c.attr && f(d).attr(c.attr),
      c.children &&
        f.each(c.children, function (g, e) {
          d.appendChild(e)
        }),
  ...
  function K(a) {
    E === y &&
      (E = -1 === I.serializeToString(f.parseXML(A['xl/worksheets/sheet1.xml'])).indexOf('xmlns:r'))
      ...
      if (f.isPlainObject(c)) K(c)
        ...
        if (E) {
          ...
          for (n = e.length; g < n; g++)
            (m = c.createAttribute(e[g].name.replace(':', '_dt_b_namespace_token_'))),
              (m.value = e[g].value),
              d.setAttributeNode(m)
        }
  ...
  l.Client.prototype = {
    ...
    positionElement: function () {
      var a = l.getDOMObjectPosition(this.domElement),
        b = this.div.style
      b.position = 'absolute'
      b.width = a.width + 'px'
    ...
    receiveEvent: function (a, b) {
      ...
      if (this.handlers[a])
        for (var d = 0, g = this.handlers[a].length; d < g; d++) {
  ...
  l.hasFlash = function () {
    try {
      ...
      if (
        navigator.mimeTypes &&
        navigator.mimeTypes['application/x-shockwave-flash'] !== y &&
  ...
  var L = function (a, b) {
    ...
    M = function (a, b) {
      ...
      var d = b.fieldBoundary,
        ...
        m = function (k) {
          for (var h = '', B = 0, u = k.length; B < u; B++)
            0 < B && (h += g), (h += d ? d + ('' + k[B]).replace(e, n + d) + d : k[B])
          return h
        },
        C = b.header ? m(a.header) + c : ''
      b = b.footer && a.footer ? c + m(a.footer) : ''
      for (var v = [], p = 0, D = a.body.length; p < D; p++) v.push(m(a.body[p]))
  ...
  z.ext.buttons.copyFlash = f.extend({}, H, {
    ...
    action: function (a, b, c, d) {
      d._fromFlash &&
        ...
        (a = d._flash),
        (c = M(b, d)),
        (d = d.customize ? d.customize(c.str, d) : c.str),
        a.setAction('copy'),
        G(a, d),
        this.processing(!1),
        b.buttons.info(
          ...
          b.i18n(
            'buttons.copySuccess',
            { _: 'Copied %d rows to clipboard', 1: 'Copied 1 row to clipboard' },
            c.rows
          ),
          3e3
        ))
  ...
  z.ext.buttons.excelFlash = f.extend({}, H, {
    ...
    action: function (a, b, c, d) {
      ...
      var m,
        ...
        v = function (k) {
          ...
          for (var h = 0, B = k.length; h < B; h++) {
            for (var u = h, w = ''; 0 <= u; )
              (w = String.fromCharCode((u % 26) + 65) + w), (u = Math.floor(u / 26) - 1)
            u = w + '' + m
            var x = null
            if (null !== k[h] && k[h] !== y && '' !== k[h]) {
              ...
              x ||
                ('number' === typeof k[h] ||
                (k[h].match && k[h].match(/^-?\d+(\.\d+)?$/) && !k[h].match(/^0\d+/))
                  ? (x = t(e, 'c', {
                      attr: { t: 'n', r: u },
                      children: [t(e, 'v', { text: k[h] })]
                    }))
                  : ((w = k[h].replace
                      ? k[h].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')
                      : k[h]),
                    (x = t(e, 'c', {
                      attr: { t: 'inlineStr', r: u },
      ...
      p = 0
      for (D = b.header.length; p < D; p++)
        v.appendChild(
          t(e, 'col', { attr: { min: p + 1, max: p + 1, width: O(b, p), customWidth: 1 } })
        )
