...
;(function (e) {
  ...
  function t(a, b, d) {
    for (var f = [], e = 0, c = a.childNodes.length; e < c; e++)
      ...
      if (0 > b || b >= i) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b)
        ...
        if (null !== a.aaSortingFixed) {
          ...
          for (g = a.aaSortingFixed.length; c < g; c++)
            a.aaSortingFixed[c][0] = m[a.aaSortingFixed[c][0]]
        }
        c = 0
        for (g = i; c < g; c++) {
          k = a.aoColumns[c]
        ...
        if (a.aoColumns[b].bVisible) {
          ...
          l = null
          for (c = d < b ? d : d + 1; null === l && c < i; )
            (l = this.oApi._fnColumnIndexToVisible(a, c)), c++
          ...
          c = 0
          for (g = a.aoData.length; c < g; c++) null !== a.aoData[c].nTr && t(a.aoData[c].nTr, n, l)
        }
        q(a.aoColumns, b, d)
        c = 0
        ...
        c = 0
        for (g = i; c < g; c++)
          e(a.aoColumns[c].nTh).off('.DT'),
            this.oApi._fnSortAttachListener(a, a.aoColumns[c].nTh, c)
        e(a.oInstance).trigger('column-reorder.dt', [
          a,
          { from: b, to: d, mapping: m, drop: f, iFrom: b, iTo: d, aiInvertMapping: m }
        ])
      }
  }
  var i = function (a, b) {
  ...
  e.extend(i.prototype, {
    ...
    _fnConstruct: function () {
      ...
      if (h)
        if (a.s.dt._bInitComplete) (b = r(h)), a._fnOrderColumns.call(a, b)
          ...
          var c = !1
          e(d).on('draw.dt.colReorder', function () {
    ...
    _fnStateSave: function (a) {
      ...
      if (a.aaSorting) {
        for (b = 0; b < a.aaSorting.length; b++)
          a.aaSorting[b][0] = h[a.aaSorting[b][0]]._ColReorder_iOrigCol
        var c = e.extend(!0, [], a.aoSearchCols)
        b = 0
        for (d = h.length; b < d; b++)
          (f = h[b]._ColReorder_iOrigCol),
            (a.aoSearchCols[f] = c[b]),
            (a.abVisCols[f] = h[b].bVisible),
            a.ColReorder.push(f)
      } else if (a.order) {
        ...
        b = 0
        for (d = h.length; b < d; b++)
          (f = h[b]._ColReorder_iOrigCol), (a.columns[f] = c[b]), a.ColReorder.push(f)
      }
    },
    ...
    _fnMouseDown: function (a, b) {
      ...
      h !== s &&
        ...
        (this.s.mouse.target = this.s.dt.aoColumns[h].nTh),
        (this.s.mouse.targetIndex = h),
        (this.s.mouse.fromIndex = h),
        this._fnRegions(),
        e(o)
    ...
    _fnMouseMove: function (a) {
      ...
      for (
        ...
        a: {
          for (g = c; 0 <= g; ) {
            ...
            if (b.s.aoTargets[g + 1].x !== b.s.aoTargets[g].x) {
              g = b.s.aoTargets[g]
              break a
            }
          }
      ...
      d
        ? (this.dom.pointer.css('left', d.x), (this.s.mouse.toIndex = d.to))
        : (this.dom.pointer.css('left', h().x), (this.s.mouse.toIndex = h().to))
    ...
    _fnCreateDragNode: function () {
      ...
      this.dom.drag = e(h.cloneNode(!1))
        ...
        .append(e(f.cloneNode(!1)).append(e(d.cloneNode(!1)).append(c[0])))
        .css({
          position: 'absolute',
          top: 0,
          left: 0,
  ...
  e.fn.dataTable.Api.register('colReorder.move()', function (a, b, d, e) {
    this.context.length &&
      (this.context[0]._colReorder.s.dt.oInstance.fnColReorder(a, b, d, e),
