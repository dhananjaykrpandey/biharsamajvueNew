...
;(function (b) {
  ...
  b.extend(u.prototype, {
    _constructor: function () {
      ...
      c.on('draw.dtr', function () {
        ...
        'dt' === g.namespace &&
          (a._resizeAuto(), a._resize(), b.inArray(!1, a.s.current) && c.columns.adjust())
      })
      this._resize()
    },
    _columnsVisiblity: function (a) {
      ...
      for (f = g.length; e < f; e++) {
        ...
        '-' === l[q] &&
          !d[q].control &&
          d[q].minWidth &&
          (r || 0 > h - d[q].minWidth ? ((r = !0), (l[q] = !1)) : (l[q] = !0), (h -= d[q].minWidth))
      }
      g = !1
      e = 0
    ...
    _detailsDisplay: function (a, c) {
      ...
      if (g && !1 !== g.type) {
        ...
        ;(!0 !== l && !1 !== l) ||
          b(f.table().node()).triggerHandler('responsive-display.dt', [f, a, l, c])
      }
    },
      ...
      if (f !== n || null !== f)
        b(c.table().body()).on('click.dtr mousedown.dtr mouseup.dtr', d, function (g) {
          if (
            ...
            -1 !== b.inArray(b(this).closest('tr').get(0), c.rows().nodes().toArray())
          ) {
            if ('number' === typeof f) {
            ...
            'click' === g.type
              ...
              : 'mouseup' === g.type && b(this).trigger('blur').css('outline', '')
          }
        })
    },
  ...
  b(m).on('preInit.dt.dtr', function (a, c, d) {
    'dt' === a.namespace &&
      ...
      ((a = c.oInit.responsive), !1 !== a && new u(c, b.isPlainObject(a) ? a : {}))
  })
  return u
})
