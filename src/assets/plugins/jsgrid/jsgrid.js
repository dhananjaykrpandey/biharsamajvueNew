...
;(function (window, $, undefined) {
  ...
  Grid.prototype = {
    ...
    _setSortingParams: function (field, order) {
      ...
      order =
        order ||
        (this._sortField === field ? this._reversedSortOrder(this._sortOrder) : SORT_ORDER_ASC)
    ...
    showPrevPages: function () {
      ...
      this._firstDisplayingPage =
        firstDisplayingPage > pageButtonCount ? firstDisplayingPage - pageButtonCount : 1
    ...
    _createEditRow: function (item) {
      ...
      this._eachField(function (field) {
        ...
        this._prepareCell('<td>', field, 'editcss')
          .append(
            this.renderTemplate(field.editTemplate || '', field, { value: fieldValue, item: item })
          )
          .appendTo($result)
      })
...
;(function (jsGrid, $, undefined) {
  ...
  ControlField.prototype = new Field({
    ...
    _createModeSwitchButton: function () {
      ...
      var updateButtonState = $.proxy(function () {
        $button
          .attr('title', isInserting ? this.searchModeButtonTooltip : this.insertModeButtonTooltip)
