...
;(function (mod) {
  ...
  CodeMirror.defineMode('verilog', function (config, parserConfig) {
    var indentUnit = config.indentUnit,
      ...
      compilerDirectivesUseRegularIndentation =
        parserConfig.compilerDirectivesUseRegularIndentation,
    ...
    return {
      ...
      indent: function (state, textAfter) {
        ...
        if (ctx.type == 'statement')
          ...
          (closingBracket.test(ctx.type) || ctx.type == 'assignment') &&
          ctx.align &&
          !dontAlignCalls
        )
