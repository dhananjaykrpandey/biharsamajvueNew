    ...
    FixedColumns.prototype._addStyles = function () {
      ...
      for (var i = 0; i < numCols; i++) {
        ...
        if (i < this.c.left) {
          ...
          colHeader.css(this._getCellCSS(true, distLeft, 'left')).addClass(this.classes.fixedLeft)
          colFooter.css(this._getCellCSS(true, distLeft, 'left')).addClass(this.classes.fixedLeft)
        } else {
