              ...
              value: function accept(file, done) {
                if (
                  ...
                  this.getAcceptedFiles().length >= this.options.maxFiles
                    ...
                    this.options.dictMaxFilesExceeded.replace('{{maxFiles}}', this.options.maxFiles)
                  )
              ...
              value: function _uploadData(files, dataBlocks) {
                ...
                xhr.ontimeout = function () {
                  _this15._handleUploadError(
                    files,
                    xhr,
                    'Request timedout after '.concat(_this15.options.timeout / 1000, ' seconds')
                  )
                }
                ...
                if (!files[0].upload.chunked) {
                  ...
                  for (var i = 0; i < _file2.upload.totalChunkCount; i++) {
                    if (
                      ...
                      typeof _file2.upload.chunks[i].progress !== 'undefined'
                    ) {
